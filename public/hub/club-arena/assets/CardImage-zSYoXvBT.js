<<<<<<<< HEAD:public/hub/club-arena/assets/CardImage-BONzjI1L.js
import{s as m}from"./index-Dr3dBr8l.js";import{j as h}from"./vendor-react-1ylW9eih.js";class y{async getHand(e){const{data:a,error:s}=await m.from("hands").select(`
========
import{s as m}from"./index-B3aQPW79.js";import{j as h}from"./vendor-react-ChGGaEAk.js";class y{async getHand(e){const{data:a,error:s}=await m.from("hands").select(`
>>>>>>>> 8df132f0d (chore: update Club Arena dist — player stats perf + UI redesign):public/hub/club-arena/assets/CardImage-zSYoXvBT.js
                *,
                hand_players (
                    seat,
                    user_id,
