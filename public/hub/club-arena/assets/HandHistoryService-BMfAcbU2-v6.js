import{s as _,r as p}from"./index-C1e9-_Io-v6.js";import"./vendor-react-ChGGaEAk-v6.js";import"./vendor-supabase-BLlQ2fJ4-v6.js";class N{async getHand(e){const{data:t,error:s}=await _.from("hands").select(`
                *,
                hand_players (
                    seat,
                    user_id,
