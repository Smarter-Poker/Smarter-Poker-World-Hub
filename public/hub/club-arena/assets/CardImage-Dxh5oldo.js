import{s as u}from"./index-Dx1U_hzn.js";import{j as h}from"./vendor-react-1ylW9eih.js";class y{async getHand(e){const{data:a,error:s}=await u.from("hands").select(`
                *,
                hand_players (
                    seat,
                    user_id,
