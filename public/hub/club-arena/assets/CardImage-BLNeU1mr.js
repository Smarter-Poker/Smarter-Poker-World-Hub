import{s as u}from"./index-8-6uzTQL.js";import{j as h}from"./vendor-react-BBaYhDCi.js";class y{async getHand(e){const{data:a,error:s}=await u.from("hands").select(`
                *,
                hand_players (
                    seat,
                    user_id,
