import{s as m}from"./index-DqEqq0E9.js";import{j as h}from"./vendor-react-ChGGaEAk.js";class y{async getHand(e){const{data:a,error:s}=await m.from("hands").select(`
                *,
                hand_players (
                    seat,
                    user_id,
