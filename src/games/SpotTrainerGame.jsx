...
const SPOT_SCENARIOS = [
    {
        ...
        streets: [
            {
                street: 'preflop',
                description: 'You raise first in from the Button to 2.5 BB. The Big Blind calls.',
                pot: 5.5,
                heroStack: 97.5,
                villainStack: 97.5,
                board: [],
            ...
            },
            {
                ...
                options: [
                    ...
                    { action: 'Bet 125%', correct: false, ev: -0.4 },
                ],
            ...
            },
            {
                ...
                options: [
                    ...
                    { action: 'Bet 75%', correct: false, ev: -0.4 },
                    { action: 'Bet 125%', correct: false, ev: -1.1 },
                ],
            ...
            },
            {
                ...
                options: [
                    ...
                    { action: 'Bet 125%', correct: false, ev: -1.5 },
                ],
    ...
    },
    {
        ...
        streets: [
            {
                street: 'preflop',
                description: 'Action folds to Under The Gun, who raises to 2.5 BB. You are in the Cutoff with K♠K♦. What is your best action?',
                pot: 4,
                heroStack: 100,
                villainStack: 97.5,
                board: [],
            ...
            },
            {
                ...
                options: [
                    ...
                    { action: 'Bet 125%', correct: false, ev: 0.8 },
                ],
            ...
            },
            {
                ...
                options: [
                    ...
                    { action: 'Bet 125%', correct: false, ev: 1.7 },
                ],
            ...
            },
            {
                ...
                options: [
                    ...
                    { action: 'Bet 25%', correct: false, ev: 4.4 },
                ],
        ...
        streets: [
            {
                ...
                options: [
                    ...
                    { action: '4-bet all-in', correct: false, ev: -2.4 },
                ],
                explanation: 'JTs is too strong to fold and has great playability. Call and see a flop.',
            },
            {
                street: 'flop',
                description: 'On the flop, the Small Blind bets 33% pot into you (Pot: 18 BB).',
                pot: 18,
                heroStack: 91,
                villainStack: 91,
                board: ['9h', '8c', '2h'],
                ...
                options: [
                    ...
                    { action: 'Check-fold', correct: false, ev: -0.8 },
                ],
            ...
            },
            {
                ...
                options: [
                    ...
                    { action: 'Check-raise', correct: false, ev: 1.2 },
                ],
            ...
            },
            {
                ...
                options: [
                    ...
                    { action: 'Bet 75%', correct: false, ev: 7.1 },
                ],
        ...
        streets: [
            {
                ...
                options: [
                    ...
                    { action: '4-bet to 16BB', correct: false, ev: -0.8 },
                ],
    ...
    },
    {
        ...
        streets: [
            {
                street: 'preflop',
                description: 'Under The Gun raises first in, Middle Position calls, and you 3-bet to 12 BB from the Cutoff with Q♠Q♣. Under The Gun calls and Middle Position folds.',
                pot: 27.5,
                heroStack: 88,
                villainStack: 88,
                board: [],
            ...
            },
            {
                ...
                options: [
                    ...
                    { action: 'Bet 125%', correct: false, ev: 1.4 },
                ],
    ...
    },
    {
        ...
        streets: [
            {
                street: 'preflop',
                description: 'Action folds to the Cutoff, who raises; you call from the Button with 8♥7♥.',
                pot: 5.5,
                heroStack: 97.5,
                villainStack: 97.5,
                board: [],
            ...
            {
                street: 'flop',
                description: 'On the flop, the Cutoff bets 50% pot into you (Pot: 5.5 BB).',
                pot: 5.5,
                heroStack: 97.5,
                villainStack: 97.5,
                board: ['Kh', '5h', '2c'],
                ...
                options: [
                    ...
                    { action: 'Raise all-in', correct: false, ev: -1.1 },
                ],
                explanation: 'Flush draw with position. Call and see the turn.',
            },
            {
                street: 'turn',
                description: 'You call the Cutoff\'s 2.7 BB flop bet. On the turn, the Cutoff checks to you (Pot: 10.9 BB).',
                pot: 10.9,
                heroStack: 94.8,
                villainStack: 94.8,
                board: ['Kh', '5h', '2c', '3h'],
                heroHand: ['8h', '7h'],
                options: [
                    { action: 'Check back', correct: false, ev: 4.5 },
                    { action: 'Bet 33%', correct: false, ev: 6.2 },
            ...
            {
                street: 'river',
                description: 'The Cutoff calls your turn bet, then checks to you on the river (Pot: 27.3 BB).',
                pot: 27.3,
                heroStack: 86.6,
                villainStack: 86.6,
                ...
                heroHand: ['8h', '7h'],
                options: [
                    { action: 'Check back', correct: false, ev: 8.5 },
                    { action: 'Bet 33%', correct: false, ev: 10.2 },
