...
export class DeterministicGTOEngine {
    ...
    buildExplanation(heroHand, board, street, optimalAction, handActions, ev, validActions, ctx = {}) {
        ...
        const allNotesRaw = [sizingReason, trapNote, checkRaiseNote, overbetNote, thinValueNote,
            ...
            valueThickNote, mergedPolarNote, nodeLockNote, icmNote, blindVsBlindNote].filter(Boolean);
    ...
    getEngineStats() {
        return {
            version: '2.3.0-phase175',
            phasesImplemented: 175,
            explanationModules: {
            ...
            totalExplanationNotes: 72, // Number of notes in allNotes pipeline
