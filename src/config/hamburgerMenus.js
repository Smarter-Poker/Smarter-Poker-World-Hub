...
export const MENU_CONFIGS = {
  ...
  training: (user, state, handlers) => ({
    menuItems: [
      ...
      createMenuItem.toggle('Sound Effects', state.soundEnabled || false, handlers.setSoundEnabled),
  ...
  messenger: (user, state, handlers) => ({
    ...
    bottomLinks: [{ label: 'Help', href: '/hub/help', icon: MenuIcons.help }],
  }),
  ...
  'diamond-store': (user, state, handlers) => ({
    ...
    bottomLinks: [{ label: 'Help & Support', href: '/hub/help', icon: MenuIcons.help }],
  }),
  ...
  settings: (user, state, handlers) => ({
    menuItems: [
      ...
      createMenuItem.navigation(
        'Account Settings',
        '/hub/settings?section=account',
        MenuIcons.settings
      ),
      createMenuItem.navigation(
        'Privacy & Security',
        '/hub/settings?section=privacy',
        MenuIcons.lock
      ),
      createMenuItem.navigation(
        'Notifications',
      ...
      createMenuItem.navigation(
        'Display & Sound',
        '/hub/settings?section=display',
        MenuIcons.sliders
      ),
      createMenuItem.navigation(
        'Billing & Payments',
        '/hub/settings?section=billing',
        MenuIcons.wallet
      ),
      createMenuItem.divider(),
  ...
  'my-clubs': () => ({
    menuItems: [
      ...
      createMenuItem.navigation('Club Arena', '/hub/club-arena', MenuIcons.trophy, null, null, {
        hardNav: true,
      }),
    ],
    bottomLinks: [
  ...
  'odds-calculator': () => ({
    menuItems: [
      ...
      createMenuItem.navigation(
        'Equity Calculator',
        '/hub/training/equity-calculator',
        MenuIcons.percent
      ),
    ...
    bottomLinks: [{ label: 'Help And Support', href: '/hub/help', icon: MenuIcons.help }],
  }),
  ...
  'bankroll-manager': (user, state, handlers) => ({
    menuItems: [
      ...
      createMenuItem.toggle(
        'Display EUR',
        state.currencyEUR || false,
        handlers.setCurrencyEUR,
        'Show amounts in Euros'
      ),
  ...
  'poker-near-me': (user, state, handlers) => ({
    menuItems: [
      ...
      createMenuItem.navigation(
        'Game Trends',
        '/hub/poker-near-me/lobby?pod=gametrends',
        null,
        null,
        null,
        { hardNav: true }
      ...
      createMenuItem.navigation(
        'Peak Activity',
        '/hub/poker-near-me/lobby?pod=peakheatmap',
        null,
        null,
        null,
        { hardNav: true }
      ...
      createMenuItem.navigation(
        'Compare Venues',
        '/hub/poker-near-me/lobby?pod=compare',
        null,
        null,
        null,
        { hardNav: true }
      ...
      createMenuItem.toggle(
        'Geofence Alerts',
        state.geofenceAlerts !== false,
        handlers.setGeofenceAlerts,
        'Get Notified When Near Poker Venues'
      ),
      createMenuItem.toggle(
        'Location Services',
        state.locationEnabled !== false,
        handlers.setLocationEnabled
      ),
      createMenuItem.toggle(
        'Show Newcomer-Friendly',
        state.showNewcomerFriendly !== false,
        handlers.setShowNewcomerFriendly
      ),
    ],
    bottomLinks: [{ label: 'Help', href: '/hub/help', icon: MenuIcons.help }],
  }),
  ...
  'diamond-arena': (user, state, handlers) => ({
    ...
    bottomLinks: [{ label: 'Help & Rules', href: '/hub/help', icon: MenuIcons.help }],
  }),
  ...
  sandbox: (user, state, handlers) => {
    const gridItems1 = [
      {
        label: `Quiz ${state.quizMode ? 'ON' : 'OFF'}`,
        onClick: handlers.onToggleQuiz,
        icon: MenuIcons.checklist,
      },
      {
        label: `Coach ${state.coachMode ? 'ON' : 'OFF'}`,
        onClick: handlers.onToggleCoach,
        icon: MenuIcons.brain,
      },
    ...
    return {
      menuItems: [
        ...
        createMenuItem.toggle(
          ...
          'Overlay board equity on the felt',
          MenuIcons.heatmap
        ),
        createMenuItem.toggle(
          'Node Locks',
          state.showNodeLocks,
          handlers.onToggleNodeLocks,
          'Lock villain frequencies to exploit them',
          MenuIcons.lock
        ),
        createMenuItem.toggle(
          'Sound',
      ...
      bottomLinks: [
        {
          ...
          label: 'Play Tutorial',
          icon: MenuIcons.help,
          onClick: handlers.onPlayTutorial,
          action: true,
        },
      ...
      ...(handlers?.onToggleResolved
        ? [
            ...
            createMenuItem.toggle(
              ...
              !!state?.showResolved,
              handlers.onToggleResolved,
              'Include leaks you have already fixed',
              MenuIcons.checklist
            ),
          ]
        : []),
  ...
  profile: (user, state, handlers) => ({
    ...
    bottomLinks: [{ label: 'Settings', href: '/hub/settings', icon: MenuIcons.settings }],
  }),
    ...
    menuItems: [
      ...
      createMenuItem.navigation(
        ...
        state.clubPageCreated
          ? '/hub/social-media?view=club-pages'
          : '/hub/social-media?createPage=true',
        MenuIcons.grid
      ),
      ...(state.clubPageCreated
        ? []
  ...
  'toke-tracker': (user, state, handlers) => ({
    menuItems: [
      ...
      createMenuItem.navigation(
        'Tax Summary & Export',
        '/hub/toke-tracker/vault?tab=tax',
        MenuIcons.fileText
      ),
  ...
  'club-arena': (user, state, handlers) => ({
    menuItems: [
      ...
      createMenuItem.navigation('My Clubs', '/hub/club-arena', MenuIcons.grid, null, null, {
        hardNav: true,
      }),
      createMenuItem.navigation('Find Clubs', '/hub/club-arena#find', MenuIcons.users, null, null, {
        hardNav: true,
      }),
      createMenuItem.navigation(
        'Create Club',
        '/hub/club-arena#create',
        MenuIcons.userPlus,
        null,
        null,
        { hardNav: true }
      ...
      createMenuItem.navigation(
        'Tournaments',
        '/hub/club-arena?mode=tournament',
        MenuIcons.trophy,
        null,
        null,
        { hardNav: true }
      ...
      createMenuItem.toggle('Compact View', state.compactView || false, handlers.setCompactView),
      createMenuItem.divider(),
      createMenuItem.navigation('Table Preferences', '/hub/settings?section=table'),
      createMenuItem.navigation('Privacy Settings', '/hub/settings?section=privacy'),
    ],
...
export function applyWorldMenuDeck(config = {}, worldOrPath) {
  const world = typeof worldOrPath === 'string' ? resolveWorldMenu(worldOrPath) : worldOrPath;
