...
export const POKER_IQ_ORBS: OrbConfig[] = [
    ...
    { id: 'personal-assistant', color: '#0088ff', label: 'Personal Assistant', gradient: ['#64b5f6', '#1565c0'], imageUrl: '/cards/personal-assistant.jpg', description: 'YOUR COACH — FINDS YOUR LEAKS AND LEVELS UP YOUR GAME' },
