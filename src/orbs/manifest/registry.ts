...
export const POKER_IQ_ORBS: OrbConfig[] = [
    ...
    { id: 'MLB-ANALYTICS', color: '#003A70', label: 'MLB Analytics', gradient: ['#003A70', '#CE1141'], imageUrl: '/cards/mlb-analytics-v2.jpg', description: 'MLB SPORTS BETTING ANALYTICS AND PREDICTIONS' },
];
