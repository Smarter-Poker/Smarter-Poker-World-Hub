    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <span style={{ fontSize: 20 }}><img src="/images/diamond.webp" alt="Diamond" style={{width:20,height:20,display:"inline-block",verticalAlign:"middle"}}/></span>
                    <span
                        style={{
                            fontFamily: 'Rajdhani, sans-serif',
                            fontSize: 16,
            ...
            >
                <BottomCard imageUrl="/images/news_card_art.webp" label="NEWS" onClick={() => router.push('/hub/news')} />
