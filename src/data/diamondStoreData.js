...
// (STANDARD_REWARDS entries stay {id, name, amount, note, category, icon};
// EASTER_EGGS stays an object bucketed by egg category).
//
// THE REAL CEILINGS (from the catalog: never re-typed by hand):
// • Daily cap 110 Diamonds free / 150 Diamonds VIP, measured AFTER the multiplier.
// • Monthly cap 3,300 Diamonds free / 4,500 Diamonds VIP (1 Diamond = $0.01, so $33 / $45).
...
// • Easter eggs draw on a separate 1,000 Diamonds/month budget that sits OUTSIDE the
//   daily and monthly caps (raised from 500 on 2026-08-05, migration
//   20260805210000). The per-egg ceiling is 1,000 Diamonds but the biggest egg in
//   the catalog pays 500 Diamonds: use biggestEggValue(), not the budget, in copy.
...
function formatAmount(r) {
  ...
  if (max && max > r.diamonds)
    return `${formatDiamonds(r.diamonds)}-${formatDiamonds(max)} Diamonds`;
...
function formatLimit(r) {
  ...
  if (r.oncePerTarget && r.maxPerDay > 1)
    return `Up To ${r.maxPerDay}/Day, One Payout Per Item Ever`;
...
function formatCapNote(r) {
  if (r.category === 'secret') {
    return `Separate ${formatDiamonds(CATALOG_EASTER_EGG_MONTHLY_CAP)} Diamonds/Month Egg Budget`;
  }
  if (r.category === 'referral') return 'Separate Referral Budget, Own Monthly Limit';
  if (r.countsTowardDailyCap) {
    return `Counts Toward Your ${formatDiamonds(CATALOG_DAILY_CAP.free)} Diamonds/Day Cap`;
  }
...
function referralNote() {
  return [
    `${formatDiamonds(CATALOG_REFERRAL.referrer)} Diamonds To You + ${formatDiamonds(CATALOG_REFERRAL.referee)} Diamonds To Your Friend`,
...
// legendary 300-500. The biggest egg in the catalog pays 500 Diamonds (the hard
// per-egg ceiling is 1,000 Diamonds), and all eggs together draw on one 1,000 Diamonds/month
...
export const VIP_BENEFITS = [
  ...
  {
    title: 'Every Premium Day Pass Included, Every Single Day',
    description:
      'VIP Replaces The 150 Diamond All-Access Pass. Bankroll Pro, Poker Near Me Pro, Personal Assistant, GTO Training, PvP Trivia, Lives And The Custom Avatar Builder All Unlock Automatically',
    value: '150 Diamonds/Day Value',
    category: 'Smarter.Poker',
  },
  {
    title: 'Full GTO AI Assistant: Every Postflop Scenario Unlocked',
    description:
      'Free Accounts Are Limited To Preflop. VIP Opens Postflop Analysis And Scenario Difficulty Levels 4 Through 10',
    value: 'VIP Only',
    category: 'Smarter.Poker',
  },
  {
    title: 'AI Hand Reader And Deep Hand Breakdowns',
    description:
      'Range Reading And Full Hand Analysis From The Personal Assistant Engine, With No Day Pass To Buy',
    value: 'VIP Only',
    category: 'Smarter.Poker',
  },
  {
    title: 'Advanced Leak Finder Analysis Suite',
    description:
      'The Complete Leak Detection Toolset Inside Personal Assistant, Which Free Accounts Rent For 100 Diamonds Per Day',
    value: '100 Diamonds/Day Value',
    category: 'Smarter.Poker',
  },
  {
    title: 'Bankroll Manager Pro: Full Session Tracking And Analytics',
    description:
      'Every Analytics Panel Unblurred And Fully Interactive. Free Accounts Rent It For 25 Diamonds Per Day',
    value: '25 Diamonds/Day Value',
    category: 'Smarter.Poker',
  },
  {
    title: 'Poker Near Me Pro: Venue Intelligence And Historical Activity',
    description:
      'Historical Venue Analytics And Every Advanced Filter. Free Accounts Rent It For 25 Diamonds Per Day',
    value: '25 Diamonds/Day Value',
    category: 'Smarter.Poker',
  },
  {
    title: 'Every GTO Training Game Free: No Entry Cost',
    description:
      'The 10 Diamond Entry Is Waived On Every Game, And Difficulty Levels 4 Through 10 Unlock Alongside It',
    value: 'No Diamond Cost',
    category: 'Smarter.Poker',
  },
  {
    title: 'Every Poker Trivia Game Free: No Entry Cost',
    description:
      'The 10 Diamond Entry Is Waived Across Endless, Mixed, Time Attack, Survival And Strategy Trivia',
    value: 'No Diamond Cost',
    category: 'Smarter.Poker',
  },
  {
    title: 'Free Trivia Lifelines And Hints',
    description: 'Every Hint And Lifeline Costs You Nothing Instead Of Being Charged In Diamonds',
    value: 'No Diamond Cost',
    category: 'Smarter.Poker',
  },
  {
    title: 'Entry To VIP-Only Trivia Tournaments',
    description:
      'Trivia Tournaments Are Restricted To VIP Members. The Tournament Buy-In Still Applies Normally',
    value: 'VIP Only',
    category: 'Smarter.Poker',
  },
  {
    title: 'Higher Daily Diamond Earning Cap',
    description: 'Earn Up To 150 Diamonds Per Day Instead Of The Free Ceiling Of 110',
    value: '150 Diamonds/Day',
    category: 'Smarter.Poker',
  },
  {
    title: 'Higher Monthly Diamond Earning Cap',
    description: 'Earn Up To 4,500 Diamonds Per Month Instead Of The Free Ceiling Of 3,300',
    value: '4,500 Diamonds/Mo',
    category: 'Smarter.Poker',
  },
  {
    title: '500 Bonus Diamonds Credited Every Month',
    description:
      'Credited Automatically To Active Monthly And Yearly Subscriptions, And Yours To Keep Forever',
    value: '500 Diamonds/Mo',
    category: 'Smarter.Poker',
    plans: ['month', 'year'],
  },
  {
    title: 'Up To 5 Custom AI-Generated Avatars',
    description:
      'Free Accounts Get One Custom Avatar, Ever. VIP Holds Five At Once And Can Delete One To Make Room For A New Build',
    value: '5 Slots',
    category: 'Smarter.Poker',
  },
  {
    title: 'The Full VIP Avatar Library Unlocked',
    description:
      'Every Locked Avatar In The Selection Pool Opens, Including The Entire VIP-Only Set',
    value: 'VIP Only',
    category: 'Smarter.Poker',
  },
  {
    title: 'Gold VIP Badge, Crown And Profile Flair',
    description:
      'A Gold Border, Crown Icon And VIP Tag On Your Profile, The Site Header And Every Leaderboard Row',
    value: 'Exclusive',
    category: 'Smarter.Poker',
  },
  ...
  {
    title: 'Unlimited Offline Protection During Hands',
    description:
  ...
  {
    title: '500 Free Throwables Every Month',
    description:
  ...
  {
    title: 'VIP Cosmetic Frames And Borders Owned Outright',
    description:
...
export function getVipBenefitsForPlan(interval) {
  ...
  const common = VIP_BENEFITS.filter(
    (benefit) => !benefit.plans || benefit.plans.includes(normalized)
  );
...
export const MERCHANDISE = [
  ...
  {
    id: 'ice-orbit-snapback',
    name: 'Ice Orbit Snapback',
    description: 'Structured Matte-Black Snapback With An Ice-Chrome Neural Spade Crest',
    price: 34.99,
    image: '/images/merch/neural-steel/collection-02/ice-orbit-snapback.webp',
    category: 'headwear',
  },
  {
    id: 'river-signal-trucker-hat',
    name: 'River Signal Trucker Hat',
    description: 'Technical Black Trucker Hat With A Circuit-Wave Suit Signal',
    price: 32.99,
    image: '/images/merch/neural-steel/collection-02/river-signal-trucker-hat.webp',
    category: 'headwear',
  },
  {
    id: 'midnight-circuit-beanie',
    name: 'Midnight Circuit Beanie',
    description: 'Ribbed Black Cuff Beanie With A Chrome Poker-Core Circuit Emblem',
    price: 29.99,
    image: '/images/merch/neural-steel/collection-02/midnight-circuit-beanie.webp',
    category: 'headwear',
  },
  {
    id: 'dead-money-detector-tee',
    name: 'Dead Money Detector Tee',
    description: 'Heavyweight Black Tee With A Chrome Poker Radar Instrument Graphic',
    price: 31.99,
    image: '/images/merch/neural-steel/collection-02/dead-money-detector-tee.webp',
    category: 'apparel',
  },
  {
    id: 'range-architect-tee',
    name: 'Range Architect Tee',
    description: 'Heavyweight Black Tee With A Precision-Built Chrome Spade Blueprint',
    price: 31.99,
    image: '/images/merch/neural-steel/collection-02/range-architect-tee.webp',
    category: 'apparel',
  },
  {
    id: 'all-in-after-dark-tee',
    name: 'All In After Dark Tee',
    description:
      'Heavyweight Black Tee With Chrome Tournament Chips Entering A Cyan Diamond Aperture',
    price: 31.99,
    image: '/images/merch/neural-steel/collection-02/all-in-after-dark-tee.webp',
    category: 'apparel',
  },
  {
    id: 'no-free-cards-tee',
    name: 'No Free Cards Tee',
    description: 'Heavyweight Black Tee With A Locked Chrome Card-Vault Circuit Graphic',
    price: 31.99,
    image: '/images/merch/neural-steel/collection-02/no-free-cards-tee.webp',
    category: 'apparel',
  },
  {
    id: 'cold-four-bet-hoodie',
    name: 'Cold Four-Bet Hoodie',
    description: 'Heavyweight Black Hoodie With Four Chrome Betting Discs Under Diamond Pressure',
    price: 64.99,
    image: '/images/merch/neural-steel/collection-02/cold-four-bet-hoodie.webp',
    category: 'apparel',
  },
  {
    id: 'final-table-voltage-hoodie',
    name: 'Final Table Voltage Hoodie',
    description:
      'Heavyweight Black Hoodie With Seven Final-Table Seats Orbiting A Live Circuit Core',
    price: 66.99,
    image: '/images/merch/neural-steel/collection-02/final-table-voltage-hoodie.webp',
    category: 'apparel',
  },
  {
    id: 'stack-pressure-zip-hoodie',
    name: 'Stack Pressure Zip Hoodie',
    description: 'Premium Black Zip Hoodie With Mirrored Chrome Stacks And Cyan Pressure Lines',
    price: 69.99,
    image: '/images/merch/neural-steel/collection-02/stack-pressure-zip-hoodie.webp',
    category: 'apparel',
  },
  {
    id: 'river-read-polarized-sunglasses',
    name: 'River Read Polarized Sunglasses',
    description: 'Angular Matte-Black Performance Frames With Cyan Mirror Polarized Lenses',
    price: 44.99,
    image: '/images/merch/neural-steel/collection-02/river-read-sunglasses.webp',
    category: 'eyewear',
  },
  {
    id: 'final-table-mirror-sunglasses',
    name: 'Final Table Mirror Sunglasses',
    description: 'Sharp Square Black Frames With Ice-Chrome To Cyan Mirror Lenses',
    price: 49.99,
    image: '/images/merch/neural-steel/collection-02/final-table-mirror-sunglasses.webp',
    category: 'eyewear',
  },
  {
    id: 'tournament-wire-tumbler',
    name: 'Tournament Wire Insulated Tumbler',
    description: 'Matte-Black Stainless Tumbler With An Etched Neural Suit Circuit',
    price: 29.99,
    image: '/images/merch/neural-steel/collection-02/tournament-wire-tumbler.webp',
    category: 'lifestyle',
  },
  {
    id: 'neural-steel-card-protector',
    name: 'Neural Steel Card Protector',
    description: 'Weighted Blackened-Steel Card Guard With A Machined Spade-Diamond Crest',
    price: 27.99,
    image: '/images/merch/neural-steel/collection-02/neural-steel-card-protector.webp',
    category: 'tabletop',
  },
  {
    id: 'circuit-breaker-playing-cards',
    name: 'Circuit Breaker Playing Cards',
    description: 'Premium Matte-Black Poker Deck With A Symmetrical Chrome Circuit Back',
    price: 18.99,
    image: '/images/merch/neural-steel/collection-02/circuit-breaker-deck.webp',
    category: 'tabletop',
  },
  {
    id: 'range-grid-desk-mat',
    name: 'Range Grid Desk Mat',
    description: 'Wide Black Desk Mat With A Graphite Poker Range Grid And Cyan Nodes',
    price: 39.99,
    image: '/images/merch/neural-steel/collection-02/range-grid-desk-mat.webp',
    category: 'accessories',
  },
  {
    id: 'vault-cut-poker-towel',
    name: 'Vault Cut Poker Towel',
    description: 'Premium Black Microfiber Towel With Chrome Borders And Circuit Corners',
    price: 24.99,
    image: '/images/merch/neural-steel/collection-02/vault-cut-poker-towel.webp',
    category: 'accessories',
  },
];
