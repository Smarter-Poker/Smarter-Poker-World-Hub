...
export const SOURCES = [
    ...
    { id: 'POKERGO', name: 'PokerGO', logo: '/images/video-sources/pokergo.svg' },
    // Major Tours
    ...
    { id: 'NEEME', name: 'Andrew Neeme', logo: '/images/video-sources/neeme.svg' },
    { id: 'RAMPAGE', name: 'Rampage Poker', logo: '/images/video-sources/rampage.svg' },
    { id: 'MARIANO', name: 'Mariano', logo: '/images/video-sources/mariano.svg' },
    { id: 'WOLFGANG', name: 'Wolfgang Poker', logo: '/images/video-sources/wolfgang.svg' },
    { id: 'JOHNNIE', name: 'Johnnie Vibes', logo: '/images/video-sources/johnnie.svg' },
    // Training/Strategy
    { id: 'JLITTLE', name: 'Jonathan Little', logo: '/images/video-sources/jlittle.svg' },
    { id: 'POLK', name: 'Doug Polk', logo: '/images/video-sources/polk.svg' },
    { id: 'BART', name: 'Bart Hanson', logo: '/images/video-sources/bart.svg' },
    { id: 'UPSWING', name: 'Upswing Poker', logo: '/images/video-sources/upswing.svg' },
    // Celebrity Pros
    { id: 'NEGREANU', name: 'Daniel Negreanu', logo: '/images/video-sources/negreanu.svg' },
    { id: 'HELLMUTH', name: 'Phil Hellmuth', logo: '/images/video-sources/hellmuth.svg' },
    { id: 'IVEY', name: 'Phil Ivey', logo: '/images/video-sources/ivey.svg' },
    { id: 'DWAN', name: 'Tom Dwan', logo: '/images/video-sources/dwan.svg' },
    { id: 'GARRETT', name: 'Garrett Adelstein', logo: '/images/video-sources/garrett.svg' },
];
