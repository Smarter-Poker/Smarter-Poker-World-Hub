...
export const TRAINING_LIBRARY = [
    ...
    { id: 'mtt-014', name: '3-Max Blitz', focus: 'Final 3 aggression', category: 'MTT', difficulty: 4, icon: '»', tags: ['gto'] },
    ...
    { id: 'mtt-017', name: 'Blind Defense MTT', focus: 'Tournament BB play', category: 'MTT', difficulty: 3, icon: '■', tags: ['gto'] },
    ...
    // CASH GAMES (25)
    // ═══════════════════════════════════════════════════════════════════════
    { id: 'cash-001', name: 'Preflop Blueprint', focus: '6-Max RFI ranges', category: 'CASH', difficulty: 2, icon: '♠', tags: ['gto'] },
    { id: 'cash-002', name: 'C-Bet Academy', focus: 'Continuation bet sizing', category: 'CASH', difficulty: 2, icon: '▲', tags: ['gto'] },
    { id: 'cash-003', name: 'Defense Matrix', focus: 'Facing aggression', category: 'CASH', difficulty: 3, icon: '■', tags: ['gto'] },
    ...
    { id: 'cash-008', name: '4-Bet Wars', focus: 'Pre-flop escalation', category: 'CASH', difficulty: 4, icon: '»', tags: ['gto', 'math'] },
    ...
    { id: 'cash-024', name: 'Pot Control', focus: 'Medium strength hands', category: 'CASH', difficulty: 3, icon: '◇', tags: ['gto'] },
    ...
    { id: 'spins-006', name: 'Limb Trap', focus: 'Limp-call lines', category: 'SPINS', difficulty: 3, icon: '○', tags: ['exploitative'] },
    { id: 'spins-007', name: '50/50 Survival', focus: 'Extreme ICM', category: 'SPINS', difficulty: 4, icon: '◇', tags: ['math', 'gto'] },
    ...
    { id: 'psy-002', name: 'Timing Discipline', focus: 'Consistent action speed', category: 'PSYCHOLOGY', difficulty: 2, icon: '○', tags: [] },
    ...
    { id: 'psy-016', name: 'Variance Zen', focus: 'Accepting swings', category: 'PSYCHOLOGY', difficulty: 4, icon: '◇', tags: ['math'] },
    ...
    { id: 'psy-019', name: 'Autopilot Escape', focus: 'Staying present', category: 'PSYCHOLOGY', difficulty: 3, icon: '→', tags: [] },
    ...
    { id: 'adv-004', name: 'Range Construction', focus: 'Building strategies', category: 'ADVANCED', difficulty: 4, icon: '■', tags: ['gto'] },
    ...
    { id: 'adv-007', name: 'Indifference Theory', focus: 'Making villains neutral', category: 'ADVANCED', difficulty: 5, icon: '◇', tags: ['gto', 'math'], vipOnly: true },
    ...
    { id: 'adv-012', name: 'MDF Defender', focus: 'Minimum defense', category: 'ADVANCED', difficulty: 4, icon: '■', tags: ['gto', 'math'] },
    ...
    { id: 'adv-020', name: 'Level 10: GTO Apex', focus: 'Ultimate theory test', category: 'ADVANCED', difficulty: 5, icon: '★', tags: ['gto', 'math', 'exploitative'], vipOnly: true },
];
