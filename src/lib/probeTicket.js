 ...
 * Valid for +-5 minutes. Pure functions; the SAME file lives in Commander at
 * src/lib/probe/ticket.js and both repos pin the same test vector, so the two
 * copies cannot drift without a red test on one side.
 */
