...
/** Extract explicit rank+suit cards from a labelled Hold'em board. */
...
/** Extract two explicit hero cards without mistaking shorthand such as AJs. */
...
/** Catch the common impossible LLM line "Hero in CO; BTN opens; hero calls". */
function impossibleLaterPositionOpen(text) {
    ...
    // A later position can act after hero only when the text says hero had
    // already entered and is now facing a raise/3-bet. Do not flag that line.
