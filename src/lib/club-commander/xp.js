/**
 * Club Commander XP Integration
 * Reference: IMPLEMENTATION_PHASES.md - Step 2.6
 * Awards XP to players for Club Commander-related actions
 */
...
// XP values for Club Commander events
export const CLUB_COMMANDER_XP_EVENTS = {
  'waitlist.joined': {
    xp: 5,
 ...
 * @param {string} eventType - Event type from CLUB_COMMANDER_XP_EVENTS
...
export async function awardXP(playerId, eventType, metadata = {}) {
  ...
  const event = CLUB_COMMANDER_XP_EVENTS[eventType];
  if (!event) {
