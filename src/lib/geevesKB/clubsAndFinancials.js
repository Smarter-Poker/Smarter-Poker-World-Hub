...
export const MEMORY_GAMES_ENTRIES = [
    {
        id: 'mg-1', category: 'Preflop Charts',
        keywords: ['preflop charts', 'preflop', 'range training', 'preflop ranges', 'GTO ranges', 'pattern recognition', 'memory games'],
        patterns: ['what are preflop charts', 'how do preflop charts work', 'how to play preflop charts', 'where are the preflop charts', 'what are memory games'],
        answer: '**Preflop Charts** trains you to master GTO preflop ranges through high-pressure drills - the foundation of winning poker.\n\n**Why Preflop Ranges Matter:**\n- Every hand starts preflop - get this wrong and nothing else matters\n- GTO ranges define which hands to open, 3-bet, or fold from each position\n- Speed of recall under pressure mirrors live game conditions\n- Proper range construction prevents costly leaks\n\n**Training Modes:**\n- **Range Training** - Fill in the 13×13 grid with correct opens from each position\n- **Speed Drill** - Race the clock to identify correct preflop actions\n- **Pressure Cooker** - Increasing difficulty with time pressure\n- **Pattern Recognition** - Quickly classify hand combos by action\n- **Mixed Strategy** - Practice mixed-frequency decisions\n- **Tournament Mode** - Progressive levels simulating tournament depth\n\n**Features:**\n- 10 difficulty levels (Beginner to GTO Master)\n- Timed challenges and accuracy tracking\n- Daily challenges with diamond rewards\n- ELO rating, streak system, and leaderboard\n\nStart with Level 1 and progress - even 10 minutes of daily range training dramatically improves your preflop game.',
        followUps: ['How do I earn diamonds from preflop charts?', 'What level is recommended for beginners?']
    },
];
