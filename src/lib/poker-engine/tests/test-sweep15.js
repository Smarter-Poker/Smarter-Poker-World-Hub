...
function assert(condition, label) {
    ...
    else { failed++; failures.push(label); console.warn(`  ❌ FAIL: ${label}`); }
}

(async () => {
    console.debug('\n═══════════════════════════════════════════════════════════════');
    console.debug('  🔬 SWEEP 15: PLO ANTI-EXPLOIT PHASE 4 VERIFICATION');
    console.debug('═══════════════════════════════════════════════════════════════\n');
    ...
    // ═══════════════════════════════════════════════════════════════
    console.debug('--- TEST 1: Module 25 — recordRaiseSize / isMinRaiser ---');
