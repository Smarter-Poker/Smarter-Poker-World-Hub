...
(async () => {
    ...
    // ══════════════════════════════════════════════════════════════
    console.debug('═══ SECTION A: PHASE 4 BEHAVIORAL IMPACT TESTS ═══\n');
    ...
    console.debug('--- C1: Full getDecision routing produces valid PLO decisions ---');
    ...
    for (let i = 0; i < 20; i++) {
        ...
        if (i === 0) console.debug(`C5 first iteration action:`, r.action);
    ...
    console.debug('--- D1: Blacklist check fires before PLO routing ---');
    ...
    console.debug('--- E1: Core exports verify ---');
    const p1exports = [
    ...
    console.debug('--- F1: Null/undefined state fields do not crash ---');
