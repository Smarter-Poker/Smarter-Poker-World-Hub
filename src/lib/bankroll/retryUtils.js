...
function withRetry(fn_1) {
    return __awaiter(this, arguments, void 0, function (fn, retries, baseDelay) {
                        ...
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                ...
                                case 2:
                                    ...
                                    return [4 /*yield*/, new Promise(function (r) { return setTimeout(r, baseDelay * Math.pow(2, attempt)); })];
                                case 3:
                                    _c.sent();
                                    _c.label = 4;
