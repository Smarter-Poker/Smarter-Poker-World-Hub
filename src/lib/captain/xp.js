/**
 * Captain XP Integration
 * Reference: IMPLEMENTATION_PHASES.md - Step 2.6
 * Awards XP to players for Captain-related actions
 */
...
// XP values for Captain events
export const CAPTAIN_XP_EVENTS = {
  'waitlist.joined': {
    xp: 5,
 ...
 * @param {string} eventType - Event type from CAPTAIN_XP_EVENTS
...
export async function awardXP(playerId, eventType, metadata = {}) {
  ...
  const event = CAPTAIN_XP_EVENTS[eventType];
  if (!event) {
