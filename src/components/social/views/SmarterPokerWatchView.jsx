/**
 * 📺 smarter-poker-style WATCH VIEW
 * src/app/social/views/SmarterPokerWatchView.jsx
 * 
    ...
    <aside className="watch-sidebar">
        ...
        <style>{`
            .watch-sidebar {
                ...
                border-right: 1px solid ${SP_COLORS.divider};
                padding: 16px 8px;
                overflow-y: auto;
            }
...
const WatchVideoCard = ({ video }) => (
    <div className="watch-card">
        ...
        <div className="watch-header">
            <SPAvatar src={video.channelAvatar || video.author?.avatar} size={40} />
...
export default SmarterPokerWatchView;
