/**
 * 🎬 smarter-poker-style REELS
 * src/app/social/components/SmarterPokerReels.jsx
 * 
 * Short-form video content like SmarterPoker/Instagram Reels
 */
...
export const ReelCard = ({
    ...
    return (
        <div className="sp-reel-card" onClick={handlePlayPause}>
            {/* Video or Thumbnail */}
            {reel.videoUrl ? (
                <video
                    ref={videoRef}
            ...
            <div className="reel-user">
                <SPAvatar src={reel.user?.avatar} size={32} />
...
export const ReelsCarousel = ({ reels = [], onViewAll, currentUser }) => {
    ...
    return (
        <div className="sp-reels-section">
            ...
            <div className="reels-scroll-container" style={{ position: 'relative' }}>
                {/* 🔒 GUEST LOCK OVERLAY */}
                {isGuest && (
                    <div style={{
                        position: 'absolute',
