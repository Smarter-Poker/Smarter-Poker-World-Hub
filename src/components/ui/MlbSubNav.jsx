...
function MlbSubNav() {
    ...
    return (<div className="bg-[#0a0a15] border-b border-[#3d4f5f] px-4 py-3 flex gap-4 overflow-x-auto whitespace-nowrap shadow-[0_4px_20px_rgba(0,0,0,0.5)] [&::-webkit-scrollbar]:hidden" style={{ scrollbarWidth: 'none', WebkitOverflowScrolling: 'touch' }}>
            ...
            return (<link_1.default key={l.label} href={l.href} className={"pb-1 text-[18px] font-extrabold capitalize tracking-widest transition-all touch-manipulation flex-shrink-0 ".concat(isActive
