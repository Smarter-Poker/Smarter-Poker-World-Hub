        ...
        <>
            ...
            <header className="universal-header">
                ...
                <div className="header-right">
                    ...
                    >
                        <img src="/images/header-help.png" alt="Live Help" style={{ width: '160%', height: '160%', maxWidth: 'none', objectFit: 'contain', position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)' }} />
                    </button>
