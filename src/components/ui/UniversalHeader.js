        ...
        <>
            ...
            <header className="universal-header">
                ...
                <div className="header-right">
                    ...
                    >
                        <img src="/images/header-help.png" alt="Live Help" style={{ width: '120%', height: '120%', maxWidth: 'none', objectFit: 'contain', position: 'absolute', top: '38%', left: '50%', transform: 'translate(-50%, -50%)' }} />
                    </button>
