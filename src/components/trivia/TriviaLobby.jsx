...
const MODE_CARDS = [
    // TOP ROW - Strategy Modes (MTT, Cash, GTO)
    {
        ...
        diamondReward: 5,
        perfectBonus: 10,
        image: '/images/trivia/mtt-scenarios.png?v=clean2'
    },
    {
        id: 'cash',
        name: 'Cash Game',
        ...
        diamondReward: 5,
        perfectBonus: 10,
        image: '/images/trivia/cash-game.png?v=clean2'
    },
    {
        id: 'icm',
        name: 'ICM & Chip EV',
        ...
        diamondReward: 5,
        perfectBonus: 10,
        image: '/images/trivia/icm-chip-ev.png?v=clean2'
    },
    // ROW 2 - Core Trivia
    {
        id: 'history',
        ...
        diamondReward: 3,
        perfectBonus: 5,
        image: '/images/trivia/poker-history.png?v=clean2'
    },
    {
        id: 'rules',
        name: 'Rules Quiz',
        ...
        diamondReward: 3,
        perfectBonus: 5,
        image: '/images/trivia/rules-quiz.png?v=clean2'
    },
    {
        id: 'pro',
        name: 'Pro Knowledge',
        ...
        diamondReward: 5,
        perfectBonus: 10,
        image: '/images/trivia/pro-knowledge.png?v=clean2'
    },
    // ROW 3 - Challenge Modes
    {
        ...
        diamondReward: '10+',
        perfectBonus: null,
        image: '/images/trivia/survival-mode.png?v=clean2'
    },
    {
        id: 'endless',
        name: 'Endless Mode',
        ...
        diamondReward: '1+/Q',
        perfectBonus: null,
        image: '/images/trivia/endless-mode.png?v=clean2'
    },
    {
        id: 'mixed',
        name: 'Mixed Mode',
        ...
        diamondReward: '1/Q',
        perfectBonus: null,
        image: '/images/trivia/mixed-mode.png?v=clean2'
    },
    // ROW 4 - Competitive
    {
        id: 'pvp',
        ...
        perfectBonus: null,
        image: '/images/trivia/pvp-battle.png?v=clean2'
    },
    {
        id: 'tournaments',
        name: 'Tournaments',
        ...
        perfectBonus: null,
        image: '/images/trivia/tournaments.png?v=clean2'
    },
    {
        id: 'gto',
        name: 'GTO Master',
        ...
        diamondReward: 8,
        perfectBonus: 15,
        image: '/images/trivia/gto-master.png?v=clean2'
    }
];
    ...
    return (
        <div className="trivia-lobby">
            ...
            <div className="quick-stakes-section" style={{ display: 'flex', justifyContent: 'center' }}>
                ...
                >
                    <img
                        src="/images/trivia/quick-stakes.png?v=clean2"
                        alt="Quick Stakes"
                        className="mode-image-card__img"
                    />
                    {userDiamonds < 10 && (
