      ...
      <div style={{ padding: 20, background: 'rgba(0,0,0,0.3)', borderRadius: 12, border: '1px solid rgba(255,255,255,0.08)' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 10, marginBottom: 16 }}>
          <div style={{ padding: 8, background: 'rgba(255,255,255,0.03)', borderRadius: 8, textAlign: 'center' }}>
            <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.5)', marginBottom: 2 }}>Pot (BB)</div>
          ...
          <div style={{ padding: 8, background: 'rgba(255,255,255,0.03)', borderRadius: 8, textAlign: 'center' }}>
            <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.5)', marginBottom: 2 }}>Stack Behind (BB)</div>
          ...
          <div style={{ padding: 8, background: 'rgba(255,255,255,0.03)', borderRadius: 8, textAlign: 'center' }}>
            <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.5)', marginBottom: 2 }}>Streets Left</div>
          ...
          {calc.streets.map((s, i) => {
            ...
            return (
              <div key={i} style={{
                ...
                <span style={{ fontSize: 12, color: 'rgba(255,255,255,0.4)', textAlign: 'right' }}>Pot: {s.potAfter.toFixed(1)}</span>
                <span style={{ fontSize: 12, color: 'rgba(255,255,255,0.4)', textAlign: 'right' }}>SPR {s.spr}</span>
              </div>
            );
          })}
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 8 }}>
          <div style={{ padding: 8, background: 'rgba(255,255,255,0.03)', borderRadius: 8, textAlign: 'center' }}>
            ...
            <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.4)' }}>Total Invested</div>
          </div>
          <div style={{ padding: 8, background: 'rgba(255,255,255,0.03)', borderRadius: 8, textAlign: 'center' }}>
            <div style={{ fontSize: 16, fontWeight: 800, color: calc.allIn ? '#10b981' : '#f59e0b' }}>{calc.allIn ? 'YES' : 'NO'}</div>
            <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.4)' }}>All-In By River</div>
          </div>
          <div style={{ padding: 8, background: 'rgba(255,255,255,0.03)', borderRadius: 8, textAlign: 'center' }}>
            <div style={{ fontSize: 16, fontWeight: 800, color: '#fff' }}>{Math.round(calc.betFraction * 100)}%</div>
            <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.4)' }}>Bet Fraction</div>
          </div>
        </div>
      </div>
    );
