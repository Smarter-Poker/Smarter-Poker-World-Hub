        ...
        >
            ...
            {hovered && hasData && freqs && (
                <div style={{
                    ...
                    <div style={{ fontSize: 11, fontWeight: 800, color: '#00d4ff', marginBottom: 2, fontFamily: "'Orbitron', monospace" }}>
                        {hand}
                    </div>
                    {handClass && (
        ...
        >
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                    <span style={{ fontSize: 22, fontWeight: 800, color: '#00d4ff', fontFamily: "'Orbitron', monospace" }}>
                        {hand}
                    </span>
                    {isMixed && (
                        <span style={{
                ...
                {sorted.map(([action, freq], i) => {
                    ...
                    return (
                        <div key={action} style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                            <div style={{ width: 55, fontSize: 10, fontWeight: 700, color, fontFamily: "'Orbitron', monospace", textAlign: 'right' }}>
