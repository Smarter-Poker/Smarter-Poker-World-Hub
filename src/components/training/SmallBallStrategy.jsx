...
const PRINCIPLES = [
  { title: 'See More Flops Cheaply', icon: '👁️', desc: 'Open wider in position with small sizings (2-2.2x). Play more pots, risk less per pot.',
  ...
  { title: 'Control Pot Size', icon: '🎛️', desc: 'Keep pots small with medium-strength hands. Save big pots for big hands.',
