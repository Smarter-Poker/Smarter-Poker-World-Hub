            ...
            <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                    ...
                    <div style={{
                        ...
                        <img src="/images/diamond.webp" alt="Diamond" style={{ width: 20, height: 20, display: "inline-block", verticalAlign: "middle" }} /> {progression.state.totalDiamonds.toLocaleString()}
                    </div>
