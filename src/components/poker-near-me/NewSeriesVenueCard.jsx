        ...
        <div className="metal-series-card" onClick={() => onNavigate && onNavigate(detailUrl)}>
            ...
            <div className="series-body">
                ...
                <div className="series-tags">
                    {s.total_events > 0 && <span className="series-tag">{s.total_events} Events</span>}
                    {s.main_event_buyin && <span className="series-tag">{formatMoney(s.main_event_buyin)} Main</span>}
                    {s.main_event_guaranteed && <span className="series-tag" style={{ color: '#fbbf24', borderColor: 'rgba(251,191,36,0.3)' }}>{formatMoney(s.main_event_guaranteed)}+ GTD</span>}
