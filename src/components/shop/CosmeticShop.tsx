/**
 * <img src="/images/diamond.webp" alt="Diamond" style={{width:20,height:20,display:"inline-block",verticalAlign:"middle"}}/> COSMETIC SHOP - The Diamond Exchange
 * 
                    ...
                    <div style={{
                        ...
                        <div>
                            <h2 style={{
                                ...
                                <img src="/images/diamond.webp" alt="Diamond" style={{width:20,height:20,display:"inline-block",verticalAlign:"middle"}}/> Diamond Exchange
                            </h2>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                            <div style={{
                                ...
                                <span style={{ fontSize: '20px' }}><img src="/images/diamond.webp" alt="Diamond" style={{width:20,height:20,display:"inline-block",verticalAlign:"middle"}}/></span>
                                <span style={{
                                    fontSize: '18px',
                                    fontWeight: 700,
                                    color: '#00d4ff'
        ...
        >
            ...
            <div style={{ padding: '14px' }}>
                ...
                {justPurchased ? (
                    ...
                    >
                        <span><img src="/images/diamond.webp" alt="Diamond" style={{width:20,height:20,display:"inline-block",verticalAlign:"middle"}}/></span>
