  ...
  return (
    <div className="sp-club-training-table">
      ...
      <style jsx global>{`
        ...
        .sp-club-game-stage{position:relative;min-height:0;display:grid;grid-template-columns:minmax(210px,1fr) minmax(366px,605px) minmax(190px,1fr);align-items:flex-start;overflow:hidden}
        ...
        .sp-club-arena-canvas{position:relative;z-index:10;justify-self:center;height:calc(100% - 122px);max-height:1000px;margin-top:60px;aspect-ratio:605/1000;overflow:visible}
        ...
        .sp-club-community-cards{position:absolute;z-index:28;left:50%;top:43.5%;transform:translate(-50%,-50%);display:flex;gap:2px;width:68%;justify-content:center}.sp-club-card{display:inline-block;width:clamp(24px,3.2vh,38px);aspect-ratio:64/92;overflow:hidden;border:1px solid rgba(255,255,255,.84);border-radius:3px;background:#fff;box-shadow:0 5px 11px rgba(0,0,0,.72)}.sp-club-card img{display:block;width:100%;height:100%;object-fit:contain}.sp-club-card--empty{background:linear-gradient(#263039,#0b1116);border-color:#3a474f}
