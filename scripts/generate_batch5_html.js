...
// Batch 5 is 100-125 (venues 101-125)
const startIndex = 100;
const endIndex = Math.min(125, venues.length);
const batch = venues.slice(startIndex, endIndex);

let html = `<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Batch 5 — Venues #101-125</title>
<style>
...
fs.writeFileSync('public/batch5-review.html', html);
console.log("Created public/batch5-review.html");
