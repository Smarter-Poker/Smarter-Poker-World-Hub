...
// Batch 11 is 250-275 (venues #251-275 based on new array length)
const startIndex = 250;
const endIndex = Math.min(275, venues.length);
const batch = venues.slice(startIndex, endIndex);

let html = `<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Batch 11 — Venues #${startIndex + 1}-${endIndex}</title>
<style>
...
<header>
<h1>Batch 11 — Venues #${startIndex + 1}-${endIndex}</h1>
...
fs.writeFileSync('public/batch11-review.html', html);
console.log("Created public/batch11-review.html");
