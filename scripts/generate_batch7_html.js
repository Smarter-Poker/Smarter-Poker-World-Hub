...
// Batch 7 is 150-175 (venues #151-175 based on new array)
const startIndex = 150;
const endIndex = Math.min(175, venues.length);
const batch = venues.slice(startIndex, endIndex);

let html = `<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Batch 7 — Venues #151-175</title>
<style>
...
fs.writeFileSync('public/batch7-review.html', html);
console.log("Created public/batch7-review.html");
