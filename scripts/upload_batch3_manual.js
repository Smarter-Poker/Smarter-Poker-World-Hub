...
const uploads = [
  { id: 2870, file: 'media__1775371136826.jpg', ext: 'jpg' }, // Central Coast Casino
  { id: 2186, file: 'media__1775371139996.jpg', ext: 'jpg' }, // Gardens Casino
  { id: 2679, file: 'media__1775371145678.jpg', ext: 'jpg' }, // Hawaiian Gardens Poker Series
  { id: 2193, file: 'media__1775371154153.jpg', ext: 'jpg' }, // San Manuel
  { id: 2681, file: 'media__1775371156316.jpg', ext: 'jpg' }  // San Manuel Poker Series
];
...
async function main() {
  for (const upload of uploads) {
    ...
    // Manually construct the URL to bypass any cache busting querystrings if they aren't needed,
    // though getPublicUrl usually does not include a querystring.
