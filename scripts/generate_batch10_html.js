...
// Batch 10 is 225-250 (venues #226-250 based on new array length)
const startIndex = 225;
const endIndex = Math.min(250, venues.length);
const batch = venues.slice(startIndex, endIndex);

let html = `<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Batch 10 — Venues #${startIndex + 1}-${endIndex}</title>
<style>
...
<header>
<h1>Batch 10 — Venues #${startIndex + 1}-${endIndex}</h1>
...
fs.writeFileSync('public/batch10-review.html', html);
console.log("Created public/batch10-review.html");
