...
// Batch 13 is 300-325 (venues #301-325 based on new array length)
const startIndex = 300;
const endIndex = Math.min(325, venues.length);
const batch = venues.slice(startIndex, endIndex);

let html = `<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Batch 13 — Venues #${startIndex + 1}-${endIndex}</title>
<style>
...
<header>
<h1>Batch 13 — Venues #${startIndex + 1}-${endIndex}</h1>
...
fs.writeFileSync('public/batch13-review.html', html);
console.log("Created public/batch13-review.html");
