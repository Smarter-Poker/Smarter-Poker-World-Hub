...
// Batch 6 is 125-150 (venues 126-150)
const startIndex = 125;
const endIndex = Math.min(150, venues.length);
const batch = venues.slice(startIndex, endIndex);

let html = `<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Batch 6 — Venues #126-150</title>
<style>
...
fs.writeFileSync('public/batch6-review.html', html);
console.log("Created public/batch6-review.html");
