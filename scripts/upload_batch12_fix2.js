...
const uploads = [
  { id: 2757, file: 'media__1775378818200.png', ext: 'png' }, // Downtown Grand Poker Series
  { id: 2147, file: 'media__1775378823108.jpg', ext: 'jpg' }, // Four Queens
  { id: 2138, file: 'media__1775378828719.jpg', ext: 'jpg' }, // Horseshoe LV
  { id: 2737, file: 'media__1775378833473.jpg', ext: 'jpg' }  // Macau Poker Open
];
...
// Delete Fremont (ID: 2146)
venues1.venues = venues1.venues.filter(v => v.id !== 2146);
venues2.venues = venues2.venues.filter(v => v.id !== 2146);
console.log("Removed Fremont (ID 2146)");
