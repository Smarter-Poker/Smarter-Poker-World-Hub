...
// Batch 15 is 350-375 (venues #351-375 based on new array length)
const startIndex = 350;
const endIndex = Math.min(375, venues.length);
const batch = venues.slice(startIndex, endIndex);

let html = `<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Batch 15 — Venues #${startIndex + 1}-${endIndex}</title>
<style>
...
<header>
<h1>Batch 15 — Venues #${startIndex + 1}-${endIndex}</h1>
...
fs.writeFileSync('public/batch15-review.html', html);
console.log("Created public/batch15-review.html");
