...
const uploads = [
  { id: 2440, file: 'media__1775407220248.jpg', ext: 'jpg' }, // Oak Cliff Card Club
  { id: 2715, file: 'media__1775407230499.jpg', ext: 'jpg' }, // Poker House Dallas Tournament Series
  { id: 2748, file: 'media__1775407238130.png', ext: 'png' }, // TCH Dallas Poker Series
  { id: 2284, file: 'media__1775407247444.png', ext: 'png' }, // Kickapoo Lucky Eagle
  { id: 2019, file: 'media__1775407257064.png', ext: 'png' }  // House of Kings Card Club
];

const REMOVE_IDS = [2286]; // Corpus Christi Poker
...
async function main() {
  ...
  if (REMOVE_IDS.length > 0) {
    console.log(`Removing venues with IDs: ${REMOVE_IDS.join(', ')}`);
    venues1.venues = venues1.venues.filter(v => !REMOVE_IDS.includes(v.id));
    venues2.venues = venues2.venues.filter(v => !REMOVE_IDS.includes(v.id));
  }
