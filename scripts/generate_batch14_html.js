...
// Batch 14 is 325-350 (venues #326-350 based on new array length)
const startIndex = 325;
const endIndex = Math.min(350, venues.length);
const batch = venues.slice(startIndex, endIndex);

let html = `<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Batch 14 — Venues #${startIndex + 1}-${endIndex}</title>
<style>
...
<header>
<h1>Batch 14 — Venues #${startIndex + 1}-${endIndex}</h1>
...
fs.writeFileSync('public/batch14-review.html', html);
console.log("Created public/batch14-review.html");
