...
// Batch 3 is 50-75
const startIndex = 50;
const endIndex = Math.min(75, venues.length);
const batch3 = venues.slice(startIndex, endIndex);

let html = `<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Batch 3 — Venues #51-75</title>
<style>
...
fs.writeFileSync('public/batch3-review.html', html);
console.log("Created public/batch3-review.html");
