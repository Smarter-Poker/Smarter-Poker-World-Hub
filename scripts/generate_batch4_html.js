...
// Batch 4 is 75-100 (venues 76-100)
const startIndex = 75;
const endIndex = Math.min(100, venues.length);
const batch = venues.slice(startIndex, endIndex);

let html = `<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Batch 4 — Venues #76-100</title>
<style>
...
fs.writeFileSync('public/batch4-review.html', html);
console.log("Created public/batch4-review.html");
