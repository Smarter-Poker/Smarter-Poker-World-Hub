...
// Batch 12 is 275-300 (venues #276-300 based on new array length)
const startIndex = 275;
const endIndex = Math.min(300, venues.length);
const batch = venues.slice(startIndex, endIndex);

let html = `<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Batch 12 — Venues #${startIndex + 1}-${endIndex}</title>
<style>
...
<header>
<h1>Batch 12 — Venues #${startIndex + 1}-${endIndex}</h1>
...
fs.writeFileSync('public/batch12-review.html', html);
console.log("Created public/batch12-review.html");
