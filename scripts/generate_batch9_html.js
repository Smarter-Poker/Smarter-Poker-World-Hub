...
// Batch 9 is 200-225 (venues #201-225 based on new array length)
const startIndex = 200;
const endIndex = Math.min(225, venues.length);
const batch = venues.slice(startIndex, endIndex);

let html = `<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Batch 9 — Venues #${startIndex + 1}-${endIndex}</title>
<style>
...
<header>
<h1>Batch 9 — Venues #${startIndex + 1}-${endIndex}</h1>
...
fs.writeFileSync('public/batch9-review.html', html);
console.log("Created public/batch9-review.html");
