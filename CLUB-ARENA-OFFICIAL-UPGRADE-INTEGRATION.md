...
On a stop signal, halt the affected operation, diagnose its authoritative result and follow the operating law through the smallest correct repair or supported rollback. Preserve independent work and record evidence in the task checkpoint. No renewed approval gate or automatic revert is appropriate.
...
# Retired deployment audit addendum

The September 1 execution checklist was removed on September 17 because it
prescribed human-only gates, retired runners, external monitoring and scheduled
repair jobs. Its dated evidence remains in Git history; it does not assign work.
Current execution authority is root AGENTS.md, docs/agent-policy/OPERATING-LAW.md
and PUBLISHING.md. Use their existing provider routes, source fixes, direct
ownership and verified outcomes. Never replay the retired checklist.
