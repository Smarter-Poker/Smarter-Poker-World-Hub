...
- Name: 017-mlb-analytics.spec.ts >> MLB Analytics Hub >> Backtest renders
- Location: e2e/017-mlb-analytics.spec.ts:37:7
...
Error: strict mode violation: locator('h1') resolved to 2 elements:
    ...
    2) <h1 class="next-error-h1">404</h1> aka getByText('404')
