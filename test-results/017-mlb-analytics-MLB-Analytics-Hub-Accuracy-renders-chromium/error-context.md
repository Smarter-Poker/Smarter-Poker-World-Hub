...
- Name: 017-mlb-analytics.spec.ts >> MLB Analytics Hub >> Accuracy renders
- Location: e2e/017-mlb-analytics.spec.ts:32:7
...
Error: strict mode violation: locator('h1') resolved to 2 elements:
    ...
    2) <h1 class="text-2xl font-black tracking-[0.2em] uppercase text-white text-center font-['Orbitron',sans-serif]">…</h1> aka getByText('Model Accuracy')
