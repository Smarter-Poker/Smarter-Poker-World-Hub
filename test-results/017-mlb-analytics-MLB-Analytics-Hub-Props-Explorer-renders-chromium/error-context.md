...
- Name: 017-mlb-analytics.spec.ts >> MLB Analytics Hub >> Props Explorer renders
- Location: e2e/017-mlb-analytics.spec.ts:22:7
...
Error: strict mode violation: locator('h1') resolved to 2 elements:
    ...
    2) <h1 class="text-2xl font-black tracking-tight">…</h1> aka getByText('Prop Picks')
