# Smarter Captain - Turnkey Deployment Strategy

## Overview

Smarter Captain uses a **Hardware-as-a-Service (HaaS)** deployment model where clubs receive pre-configured devices that work immediately upon login. Zero IT knowledge required.
...
- Download Smarter Captain from App Store
...
const syncManager = {
  ...
  queueAction(action: CaptainAction) {
...
```
┌─────────────────────────────────────────────────────────────────────────────┐
│  SMARTER CAPTAIN                                  The Lodge    Staff: Mike  │
├────────────────────────────────────┬────────────────────────────────────────┤
│                                    │                                        │
