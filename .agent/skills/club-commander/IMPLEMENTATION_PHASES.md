# Club Commander - Implementation Phases

## Critical Instructions for All Agents

**BEFORE starting any Club Commander work:**
...
touch supabase/migrations/20260201_commander_foundation.sql
```
...
```
Location: /pages/commander/dashboard.js

Components needed:
- /src/components/commander/staff/GameGrid.jsx
- /src/components/commander/staff/WaitlistManager.jsx
- /src/components/commander/staff/QuickActions.jsx
- /src/components/commander/staff/ActivityFeed.jsx
```
...
```
APIs:
- GET /api/commander/tables/venue/[venueId]
- POST /api/commander/tables
- PATCH /api/commander/tables/[id]
- DELETE /api/commander/tables/[id]
```
...
```
Component: /src/components/commander/shared/BlindStructureEditor.jsx
...
// Channel: commander:tournament:{id}
// Event: clock:tick
```

#### Step 3.5: Clock Display Component
```
Component: /src/components/commander/player/LiveClock.jsx
...
```typescript
// POST /api/commander/tournaments/[id]/eliminate
...
```typescript
// POST /api/commander/home-games/[id]/report
...
```typescript
// POST /api/commander/promotions/[id]/winner
...
// Populate commander_analytics_daily table
```

#### Step 5.5: Manager Dashboard
```
/pages/commander/reports.js
...
```bash
# Check all Commander tables exist
psql -c "SELECT table_name FROM information_schema.tables WHERE table_name LIKE 'commander_%';"

# Check API routes exist
find pages/api/commander -name "*.js" | wc -l
# Should be 30+

# Check components exist
find src/components/commander -name "*.jsx" | wc -l
# Should be 20+
