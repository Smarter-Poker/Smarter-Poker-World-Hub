...
```typescript
// /src/lib/club-commander/auth.ts
...
```
Location: /pages/club-commander/dashboard.js

Components needed:
- /src/components/club-commander/staff/GameGrid.jsx
- /src/components/club-commander/staff/WaitlistManager.jsx
- /src/components/club-commander/staff/QuickActions.jsx
- /src/components/club-commander/staff/ActivityFeed.jsx
```
...
```
APIs:
- GET /api/club-commander/tables/venue/[venueId]
- POST /api/club-commander/tables
- PATCH /api/club-commander/tables/[id]
- DELETE /api/club-commander/tables/[id]
```
...
```
Component: /src/components/club-commander/shared/BlindStructureEditor.jsx
...
```typescript
// POST /api/club-commander/tournaments/[id]/register
...
// Channel: club-commander:tournament:{id}
// Event: clock:tick
```

#### Step 3.5: Clock Display Component
```
Component: /src/components/club-commander/player/LiveClock.jsx
...
```typescript
// POST /api/club-commander/tournaments/[id]/eliminate
...
```typescript
// POST /api/club-commander/home-games
// See API_REFERENCE.md for full spec
...
```typescript
// GET /api/club-commander/home-games
...
```typescript
// POST /api/club-commander/home-games/[id]/report
...
```typescript
// POST /api/club-commander/promotions/[id]/winner
...
```
/pages/club-commander/reports.js
...
```bash
# Check all Club Commander tables exist
psql -c "SELECT table_name FROM information_schema.tables WHERE table_name LIKE 'captain_%';"

# Check API routes exist
find pages/api/club-commander -name "*.js" | wc -l
# Should be 30+

# Check components exist
find src/components/club-commander -name "*.jsx" | wc -l
# Should be 20+

# Run tests
npm run test:club-commander
```
