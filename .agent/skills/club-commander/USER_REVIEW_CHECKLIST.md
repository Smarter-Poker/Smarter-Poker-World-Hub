...
### Database
- [ ] Run: `SELECT table_name FROM information_schema.tables WHERE table_name LIKE 'commander_%';`
...
### UI
- [ ] Visit /commander/login - see PIN login screen
- [ ] Visit /commander/dashboard - see staff terminal
- [ ] Visit /hub/commander - see player waitlist view
...
### Database
- [ ] 3 additional tables exist (commander_player_sessions, etc.)
...
10. **Changes to existing non-commander code**
