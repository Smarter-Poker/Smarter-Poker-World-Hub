# Antigravity Tasks - Club Commander
...
3. Enter app name: "Club Commander"
...
### 5. Custom Domain
**Why:** Professional URL (club-commander.smarter.poker)
**Steps:**
...
- `src/lib/club-commander/pushNotifications.js` - Server-side sending
- `src/components/club-commander/shared/PushNotificationProvider.jsx` - Client-side setup
