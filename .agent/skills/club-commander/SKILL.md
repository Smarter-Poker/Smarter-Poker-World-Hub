...
- `captain_escrow_transactions`
- `captain_dealer_marketplace`
- `captain_equipment_rentals`
...
**Streaming:**
- `captain_streams`
- `captain_hand_history`

**Responsible Gaming:**
- `captain_self_exclusions`
- `captain_spending_limits`

**Network Features:**
- `captain_leagues`
- `captain_league_standings`
- `captain_tax_events`
...
- 25,000 Smarter.Poker signups from Club Commander
...
```
/pages/api/club-commander/          # API routes
/pages/hub/club-commander/          # Player UI
/pages/club-commander/              # Staff UI
/src/components/club-commander/     # React components
/src/stores/clubCommanderStore.js  # Zustand state
/src/lib/club-commander/            # Utilities
