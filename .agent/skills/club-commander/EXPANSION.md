# Club Commander - Additional Ideas & Opportunities
...
**Why This Matters:**
Casinos already have player tracking. If Club Commander integrates with their existing systems, poker comps count toward their overall tier. Players love this. Casinos love this. Competitors can't easily replicate vendor relationships.
...
CLUB COMMANDER PASS ($9.99/month):
├── Everything in Free
...
CLUB COMMANDER PRO ($19.99/month):
├── Everything in Club Commander Pass
...
"Hey Club Commander, what's the ruling on a string bet?"
"Club Commander, calculate the side pot with three all-ins"
```
...
Club Commander becomes the "operating system" for live poker:
