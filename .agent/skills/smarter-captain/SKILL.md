# Smarter Captain - Agent Skill

## Overview

Smarter Captain is Smarter.Poker's poker room management platform designed to compete with and surpass PokerAtlas TableCaptain. It provides cloud-based software for poker clubs, casinos, and home games while serving as a user acquisition funnel for the Smarter.Poker ecosystem.
...
Smarter Captain: Club pays $0-149/mo, players MUST create Smarter.Poker account
...
| Feature | TableCaptain | Smarter Captain |
|---------|--------------|-----------------|
...
- 25,000 Smarter.Poker signups from Captain
- 5% conversion to paid training

## Usage

When working on Smarter Captain features:
...
```
/pages/api/captain/          # API routes
/pages/hub/captain/          # Player UI
/pages/captain/              # Staff UI
/src/components/captain/     # React components
/src/stores/captainStore.js  # Zustand state
/src/lib/captain/            # Utilities
/supabase/migrations/        # Database migrations
```

## Contact

For questions about Smarter Captain implementation, reference these skill documents or consult the comprehensive planning files in the repository root.
