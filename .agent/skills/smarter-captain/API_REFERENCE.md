# Smarter Captain - API Reference

## Overview

All API endpoints are located under `/api/captain/`. Authentication is handled via Supabase Auth with JWT tokens.

## Base URL

```
Production: https://smarter.poker/api/captain
Development: http://localhost:3000/api/captain
```
...
|-------|------|-------------|
| `captain_enabled` | boolean | Filter by Captain status |
...
| `VENUE_NOT_CAPTAIN` | Venue not using Captain |
