# Smarter Captain - Enhanced Features & Design System
...
+------------------------------------------------------------------+
|                                                                  |
|  SMARTER CAPTAIN                              The Lodge Card Club|
|                                                                  |
|  +----------+  +----------+  +----------+  +----------+          |
...
CREATE INDEX idx_hand_history_player ON captain_hand_history USING GIN (player_cards);
CREATE INDEX idx_incidents_venue ON captain_incidents(venue_id, created_at);
CREATE INDEX idx_escrow_status ON captain_escrow_transactions(status);
CREATE INDEX idx_exclusions_player ON captain_self_exclusions(player_id, expires_at);
```
...
| Feature | TableCaptain | Bravo | Smarter Captain |
|---------|--------------|-------|-----------------|
...
- **Purpose**: Enhancement specification for Smarter Captain
