      ...
      try {
          ...
          if (rpcError) {
              ...
              try {
                  ...
                  console.warn('[Comment] Rollback delete failed:', rollbackErr?.message || rollbackErr);
              }
              console.warn('[Comment] RPC error (claim rolled back so user can retry):', rpcError);
