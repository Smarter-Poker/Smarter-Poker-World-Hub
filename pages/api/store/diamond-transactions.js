...
export default async function handler(req, res) {
  try {
      ...
      try {
           ...
           */
          const base = () =>
              getSupabase().from('diamond_transactions').select('*', { count: 'exact' }).eq('user_id', userId);
          ...
          try {
              ...
              console.warn('[diamond-transactions] badge counts unavailable:', countErr?.message || countErr);
          }
          ...
          try {
              ...
              if (allRows) {
                  ...
                  let earned = 0, spent = 0, weekEarned = 0, weekSpent = 0;
                  let thisMonthEarned = 0, thisMonthSpent = 0;
                  let lastMonthEarned = 0, lastMonthSpent = 0;
                  ...
                  lifetime = {
                      earned, spent, weekEarned, weekSpent,
                      thisMonthEarned, thisMonthSpent, lastMonthEarned, lastMonthSpent,
                      giftsSent, giftsReceived, giftCount,
              ...
              console.warn('[diamond-transactions] lifetime stats unavailable:', statsErr?.message || statsErr);
          }
