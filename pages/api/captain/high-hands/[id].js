 ...
 * GET /api/captain/high-hands/:id - Get high hand details
 * PUT /api/captain/high-hands/:id - Update/verify high hand
 * DELETE /api/captain/high-hands/:id - Delete high hand
 */
    ...
    const { data: highHand, error } = await supabase
      ...
      .select(`
        *,
        ...
        captain_promotions:promotion_id (id, name, prize_type, prize_value),
        verifier:verified_by (id, display_name),
        captain_games:game_id (id, game_type, stakes)
      `)
      .eq('id', id)
      .single();
