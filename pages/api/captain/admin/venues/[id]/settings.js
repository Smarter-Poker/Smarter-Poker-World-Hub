/**
 * Venue Settings API
 * GET /api/captain/admin/venues/[id]/settings - Get venue settings
 * PUT /api/captain/admin/venues/[id]/settings - Update venue settings
 */
...
export default async function handler(req, res) {
  try {
    ...
    if (req.method === 'PUT') {
      ...
      await supabase.from('captain_audit_log').insert({
        venue_id: id,
        user_id: user.id,
