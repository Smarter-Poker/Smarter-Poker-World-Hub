/**
 * Incidents API
 * GET /api/captain/incidents - List incidents
...
async function handleList(req, res) {
  ...
  try {
    let query = supabase
      ...
      .select(`
        *,
        reported_by_staff:captain_staff!reported_by (id, name, role),
        resolved_by_staff:captain_staff!resolved_by (id, name, role),
