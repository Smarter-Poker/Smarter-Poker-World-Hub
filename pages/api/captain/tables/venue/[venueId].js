/**
 * Captain Tables at Venue API - GET /api/captain/tables/venue/:venueId
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (error) {
      console.error('Captain venue tables query error:', error);
    ...
    console.error('Captain venue tables API error:', error);
    return res.status(500).json({
      success: false,
