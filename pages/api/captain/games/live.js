/**
 * Captain Live Games API - GET /api/captain/games/live [Public]
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (error) {
      console.error('Captain live games query error:', error);
    ...
    console.error('Captain live games API error:', error);
    return res.status(500).json({
      success: false,
