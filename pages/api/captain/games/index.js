/**
 * Captain Games API - POST /api/captain/games
 * Create a new game
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (gameError) {
      console.error('Captain game create error:', gameError);
    ...
    await supabase.from('captain_seats').insert(seats);
    ...
    console.error('Captain games API error:', error);
    return res.status(500).json({
      success: false,
