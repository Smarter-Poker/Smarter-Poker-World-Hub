 ...
 * POST /api/captain/escrow/create-payment-intent
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const { data: escrow, error: escrowError } = await supabase
      ...
      .select('*, captain_home_games!inner(id, name, host_id)')
      .eq('id', escrow_id)
    ...
    const paymentIntent = await stripe.paymentIntents.create({
      ...
      description: `Escrow deposit for home game: ${escrow.captain_home_games?.name || 'Poker Game'}`,
