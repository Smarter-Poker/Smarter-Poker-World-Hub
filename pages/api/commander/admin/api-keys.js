 ...
 * GET /api/commander/admin/api-keys - List API keys
 * POST /api/commander/admin/api-keys - Create new API key
 * DELETE /api/commander/admin/api-keys/[id] - Revoke API key
 */
...
async function createApiKey(req, res, user) {
  try {
    ...
    // Generate API key
    const rawKey = `commander_${crypto.randomBytes(32).toString('hex')}`;
