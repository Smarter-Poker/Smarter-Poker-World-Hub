 ...
 * POST /api/club-commander/comps/redeem - Redeem player comps
 * GET /api/club-commander/comps/redeem - List redemptions
 */
...
async function redeemComps(req, res) {
  try {
    ...
    const { data: redemption } = await supabase
      .from('captain_comp_redemptions')
      .select(`
        *,
        profiles:player_id (id, display_name, avatar_url),
        captain_staff:processed_by (id, display_name)
      `)
      .eq('id', data)
      .single();
