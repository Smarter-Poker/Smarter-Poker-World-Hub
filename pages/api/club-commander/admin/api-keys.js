 ...
 * GET /api/club-commander/admin/api-keys - List API keys
 * POST /api/club-commander/admin/api-keys - Create new API key
 * DELETE /api/club-commander/admin/api-keys/[id] - Revoke API key
 */
import { createClient } from '@supabase/supabase-js';
import crypto from 'crypto';
import { withRateLimit } from '../../../../src/lib/club-commander/rateLimit';
import { logAction, AuditActions } from '../../../../src/lib/club-commander/audit';
...
async function createApiKey(req, res, user) {
  try {
    ...
    // Generate API key
    const rawKey = `club_commander_${crypto.randomBytes(32).toString('hex')}`;
