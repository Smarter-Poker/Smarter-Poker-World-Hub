/**
 * Club Commander Venue Waitlist API - GET /api/club-commander/waitlist/venue/:venueId [Public]
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (error) {
      console.error('Club Commander venue waitlist query error:', error);
    ...
    console.error('Club Commander venue waitlist API error:', error);
    return res.status(500).json({
      success: false,
