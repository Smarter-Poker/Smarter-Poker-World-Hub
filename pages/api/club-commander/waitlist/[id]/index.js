/**
 * Club Commander Waitlist Entry API - DELETE /api/club-commander/waitlist/:id
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (updateError) {
      console.error('Club Commander waitlist remove error:', updateError);
    ...
    console.error('Club Commander waitlist remove API error:', error);
    return res.status(500).json({
      success: false,
