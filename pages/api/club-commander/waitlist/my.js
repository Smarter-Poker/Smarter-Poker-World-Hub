/**
 * Club Commander My Waitlists API - GET /api/club-commander/waitlist/my
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (error) {
      console.error('Club Commander my waitlists query error:', error);
    ...
    console.error('Club Commander my waitlists API error:', error);
    return res.status(500).json({
      success: false,
