 ...
 * GET /api/club-commander/tournaments/[id]/clock - Get clock state
 * POST /api/club-commander/tournaments/[id]/clock - Clock actions (start, pause, resume, next_level, etc.)
 */
