 ...
 * GET /api/club-commander/tournaments/[id]/entries - List entries
 * POST /api/club-commander/tournaments/[id]/entries - Register player
 * PUT /api/club-commander/tournaments/[id]/entries - Update entry (rebuy, addon, seat)
 * DELETE /api/club-commander/tournaments/[id]/entries - Unregister player
 */
...
async function updateEntry(req, res, tournamentId) {
  try {
    ...
    const tournament = entry.captain_tournaments;
...
async function unregisterPlayer(req, res, tournamentId) {
  try {
    ...
    const { data: entry, error: entryError } = await supabase
      .from('captain_tournament_entries')
      .select('*, captain_tournaments(venue_id, status)')
      .eq('id', entry_id)
      .eq('tournament_id', tournamentId)
      .single();
