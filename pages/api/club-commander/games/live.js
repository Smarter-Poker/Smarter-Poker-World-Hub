/**
 * Club Commander Live Games API - GET /api/club-commander/games/live [Public]
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (error) {
      console.error('Club Commander live games query error:', error);
    ...
    console.error('Club Commander live games API error:', error);
    return res.status(500).json({
      success: false,
