/**
 * Club Commander Games API - POST /api/club-commander/games
 * Create a new game
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (gameError) {
      console.error('Club Commander game create error:', gameError);
    ...
    console.error('Club Commander games API error:', error);
    return res.status(500).json({
      success: false,
