/**
 * Club Commander Send Notification API - POST /api/club-commander/notifications/send [Staff/System]
...
export default async function handler(req, res) {
  ...
  try {
    ...
    for (const channel of channels) {
      ...
      if (error) {
        console.error(`Club Commander notification insert error (${channel}):`, error);
    ...
    console.error('Club Commander send notification error:', error);
