/**
 * Club Commander Venues API - GET /api/club-commander/venues
 * Lists venues with Club Commander enabled
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Filter by Club Commander enabled status
    if (club_commander_enabled === 'true') {
    ...
    if (error) {
      console.error('Club Commander venues query error:', error);
    ...
    console.error('Club Commander venues API error:', error);
    return res.status(500).json({
      success: false,
