/**
 * Club Commander Tables at Venue API - GET /api/club-commander/tables/venue/:venueId
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (error) {
      console.error('Club Commander venue tables query error:', error);
    ...
    console.error('Club Commander venue tables API error:', error);
    return res.status(500).json({
      success: false,
