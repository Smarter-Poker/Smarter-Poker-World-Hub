 ...
 * /club-commander/admin - Admin dashboard for managers
 */
...
import MultiVenueDashboard from '../../../src/components/club-commander/admin/MultiVenueDashboard';
import AuditLogViewer from '../../../src/components/club-commander/admin/AuditLogViewer';
import ExportManager from '../../../src/components/club-commander/admin/ExportManager';
...
export default function AdminDashboard() {
  ...
  const loadAdminData = async () => {
    ...
    try {
      ...
      const venuesRes = await fetch('/api/club-commander/admin/venues?summary=true', {
      ...
      // Load exports
      const exportsRes = await fetch('/api/club-commander/exports', {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const loadAuditLogs = async (filters = {}) => {
    try {
      ...
      const res = await fetch(`/api/club-commander/admin/audit-logs?${params}`, {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const handleCreateExport = async (formData) => {
    try {
      ...
      const res = await fetch('/api/club-commander/exports', {
        method: 'POST',
        headers: {
  ...
  return (
    <>
      <Head>
        <title>Admin Dashboard | Smarter Club Commander</title>
