/**
 * Smarter Club Commander - Marketing Landing Page
 * Public page for poker rooms to learn about and sign up for Club Commander
 */
...
export default function ClubCommanderLanding() {
  const [email, setEmail] = useState('');

  return (
    <>
      <Head>
        <title>Smarter Club Commander - Modern Poker Room Management</title>
        ...
        <nav className="fixed top-0 left-0 right-0 bg-white/80 backdrop-blur-md z-50 border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-gray-900">Smarter Club Commander</span>
            </div>
            ...
            <div className="flex items-center gap-3">
              <Link href="/club-commander/login" className="text-gray-600 hover:text-gray-900">
                Staff Login
              </Link>
              <button
        ...
        <section className="py-20 px-4" style={{ backgroundColor: '#1877F2' }}>
          <div className="max-w-3xl mx-auto text-center text-white">
            ...
            <p className="text-xl opacity-90 mb-8">
              Join hundreds of poker rooms already using Smarter Club Commander.
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-2">
                ...
                <span className="font-bold text-white">Smarter Club Commander</span>
              </div>
