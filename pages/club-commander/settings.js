/**
 * Club Commander Settings Page - Venue and staff settings
...
export default function ClubCommanderSettingsPage() {
  ...
  return (
    <>
      <Head>
        <title>Settings | {venue?.name || 'Club Commander'}</title>
      ...
      <div className="min-h-screen bg-[#F9FAFB]">
        ...
        <main className="max-w-2xl mx-auto px-4 py-6 space-y-6">
          ...
          <section className="bg-white rounded-xl border border-[#E5E7EB] divide-y divide-[#E5E7EB]">
            <button
              onClick={() => router.push('/club-commander/tables')}
            ...
            <button
              onClick={() => router.push('/club-commander/staff')}
              className="w-full p-4 flex items-center justify-between hover:bg-[#F9FAFB] transition-colors"
            >
