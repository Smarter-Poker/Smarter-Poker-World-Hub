/**
 * Club Commander Announcements Page - Send broadcasts to players
...
export default function ClubCommanderAnnouncementsPage() {
  ...
  async function handleSend() {
    ...
    try {
      const res = await fetch('/api/club-commander/notifications/send', {
        method: 'POST',
  ...
  return (
    <>
      <Head>
        <title>Announcements | {venue?.name || 'Club Commander'}</title>
