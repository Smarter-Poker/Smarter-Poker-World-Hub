          ...
          {step === 1 && (
            <div className="space-y-4">
              ...
              <button
                ...
                className="cmd-btn cmd-btn-primary w-full h-14 text-lg"
              >
                Continue
              </button>
            </div>
          ...
          {step === 2 && (
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <label className="flex items-center gap-3 p-4 cmd-panel">
                  <input
                    type="checkbox"
              ...
              <div className="flex gap-3">
                <button
                  onClick={() => setStep(1)}
                  className="cmd-btn cmd-btn-secondary flex-1 h-14 text-lg"
                >
                  Back
                </button>
                <button
                  ...
                  className="cmd-btn cmd-btn-primary flex-1 h-14 text-lg"
                >
                  Continue
                </button>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="cmd-btn cmd-btn-primary flex-1 h-14 text-lg flex items-center justify-center gap-2"
                >
                  {loading ? (
