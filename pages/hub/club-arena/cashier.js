        ...
        <>
            ...
            <div style={styles.page}>
                ...
                <div style={styles.container}>
                    ...
                    <h1 style={styles.pageTitle}>Cashier</h1>
                    ...
                    {isLoading ? (
                        ...
                        <>
                            ...
                            <div style={styles.balanceCard}>
                                <div style={styles.balanceLabel}>PLAY MONEY BALANCE</div>
                                <div style={styles.balanceAmount}>{balance.toLocaleString()}</div>
                                <div style={styles.balanceNote}>NO CASH VALUE</div>
                            </div>

                            {/* Action buttons */}
                            <div style={styles.actionGrid}>
                                <button style={styles.actionBtn}>Buy-In</button>
                                <button style={{ ...styles.actionBtn, background: FB.success }}>Cash Out</button>
                            </div>
                            ...
                            {transactions.length > 0 ? (
                                transactions.map((tx, i) => (
                                    <div key={tx.id || i} style={styles.listItem}>
                                        <div>
                                        ...
                                        <div style={{ ...styles.txAmount, color: tx.type === 'cashout' ? FB.success : FB.primary }}>
                ...
                {club && (
                    <nav style={styles.bottomNav}>
                        <div style={styles.bottomNavItems}>
                            ...
                            <Link href={`/hub/club-arena/cashier?club=${club.club_id}`} style={{ ...styles.bottomNavItem, color: FB.primary }}>
                                <svg style={styles.bottomNavIcon} viewBox="0 0 24 24" fill="currentColor">
