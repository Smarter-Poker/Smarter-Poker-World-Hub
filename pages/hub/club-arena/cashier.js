        ...
        <>
            ...
            <div style={S.page}>
                ...
                {clubIdParam && <nav style={S.bottomNav}><div style={S.bottomNavItems}>
                    ...
                    <Link href={`/hub/club-arena/cashier?club=${clubIdParam}`} style={{ ...S.bottomNavItem, color: FB.primary }}><svg style={S.bottomNavIcon} viewBox="0 0 24 24" fill="currentColor"><path d="M19 14V6c0-1.1-.9-2-2-2H3c-1.1 0-2 .9-2 2v8c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2z" /></svg><span style={S.bottomNavLabel}>Cashier</span></Link>
