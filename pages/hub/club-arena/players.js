        ...
        <>
            ...
            <div style={S.page}>
                ...
                {club && <nav style={S.bottomNav}><div style={S.bottomNavItems}>
                    ...
                    <Link href={`/hub/club-arena/players?club=${club.club_id}`} style={{ ...S.bottomNavItem, color: FB.primary }}><svg style={S.bottomNavIcon} viewBox="0 0 24 24" fill="currentColor"><path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3z" /></svg><span style={S.bottomNavLabel}>Players</span></Link>
