...
export default function SettingsPage() {
    ...
    // verification and disabling all live inside TwoFactorAuthModal now — it
    // owns the SMS flow end to end, so the old setup2FA/verify2FA/disable2FA
    // handlers here (TOTP, 6-digit, and a disable call that sent no code at
    // all and could therefore never succeed) are gone.
    useEffect(() => {
        if (show2FAModal) {
            setMfaFeedback(null);
