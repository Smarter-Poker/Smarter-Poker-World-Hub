  ...
  if (!hasUpdate) {
    return (
      <div className="fixed bottom-4 right-4 flex items-center gap-2 px-3 py-1.5 bg-[#0d1117] border border-[#3d4f5f] rounded-sm shadow-[inset_0_1px_2px_rgba(0,0,0,0.5)] z-50 pointer-events-none">
        ...
        <span className="text-[10px] font-black text-[#5a6a7a] tracking-widest uppercase ">
          System Sync
        </span>
      </div>
    );
            ...
            >
              ...
              <div className="flex flex-col items-center justify-center w-full">
                ...
                {score > 0 && label === 'Money Line' && (
                  <span
                    className={`text-[11px] font-black tracking-widest uppercase mt-1 ${ev > 0 ? 'text-[#00C853]' : 'text-red-500'}`}
                  >
                    {ev > 0 ? '+' : ''}
                    {ev}% EV
                  </span>
  ...
  return (
    <div className="relative flex flex-wrap items-center gap-4 px-4 py-3 mb-6 bg-gradient-to-b from-[#1a2332] to-[#0d1117] border-y-2 border-[#3d4f5f] shadow-[inset_0_2px_8px_rgba(0,0,0,0.8),0_4px_10px_rgba(0,0,0,0.5)] z-40">
      ...
      >
        ...
        />
        <span
          className={`text-[11px] font-black uppercase tracking-widest ${filters.actionable ? 'text-[#00D4FF]' : 'text-[#5a6a7a]'}`}
        >
      ...
      >
        ...
        />
        <span
          className={`text-[11px] font-black uppercase tracking-widest ${filters.propsOnly ? 'text-[#00BFFF]' : 'text-[#5a6a7a]'}`}
        >
          Player Props
        </span>
      </button>
      ...
      <div className="flex items-center gap-2 ml-auto bg-[#0d1117] border-2 border-[#2a3a4a] rounded-sm px-2 py-1 shadow-[inset_0_2px_4px_rgba(0,0,0,0.5)] hover:border-[#3d4f5f] transition-colors">
        <span className="text-[10px] font-black uppercase tracking-widest text-[#5a6a7a]">
          Min Edge:
        </span>
        <select
    ...
    >
      ...
      <main className="mx-auto max-w-2xl bg-[#0a0a15] min-h-screen shadow-2xl relative pb-[70px] text-slate-300 w-full">
        ...
        <header className="relative px-4 pt-6 pb-4 bg-gradient-to-b from-[#1a2332] to-[#0d1117] border-b-[3px] border-[#3d4f5f] shadow-[0_8px_30px_rgba(0,0,0,0.8)] z-10">
          ...
          <h1
            className="text-3xl font-black tracking-[0.2em] uppercase text-white drop-shadow-[0_0_8px_rgba(255,255,255,0.2)] text-center"
            style={{ fontFamily: "'Rajdhani', sans-serif" }}
          >
            MLB Analytics{' '}
        ...
        {slateStale && !fetchError && (
          <div className="mx-4 mt-5 rounded-sm border-2 border-amber-500/50 bg-[#1a1500] px-4 py-3 shadow-[0_0_15px_rgba(245,158,11,0.1),inset_0_2px_4px_rgba(0,0,0,0.5)] relative overflow-hidden">
            ...
            <p className="text-[12px] font-black tracking-widest uppercase text-amber-500">
        ...
        {fetchError && (
          <div className="mx-4 mt-5 rounded-sm border-2 border-red-500/50 bg-[#1a0a0a] px-4 py-3 shadow-[0_0_15px_rgba(239,68,68,0.1),inset_0_2px_4px_rgba(0,0,0,0.5)] relative">
            ...
            <p className="text-[12px] font-black tracking-widest uppercase text-red-500">
              System Error
            </p>
                ...
                <div className="flex items-center justify-between mb-4 pl-2 border-b border-[#2a3a4a] pb-3">
                  <div className="flex flex-col">
                    ...
                    <div className="flex items-center gap-2 mt-1.5 flex-wrap">
                      {/* SGP badge */}
                      <span className="rounded-sm bg-[#1a2030] border border-[#3d4f5f] px-1.5 py-[2px] text-[9px] font-black text-[#5a6a7a] uppercase tracking-widest">
                        SGP
                      </span>
                      {/* Game ID */}
                      ...
                      {g.lineupState === 'confirmed' ? (
                        <span className="rounded-sm bg-[#001a0a] border border-[#00C853]/50 px-1.5 py-[2px] text-[9px] font-black text-[#00C853] uppercase tracking-widest">
                          Confirmed
                        </span>
                      ) : g.lineupState === 'pending' ? (
                        <span className="rounded-sm bg-[#1a1000] border border-[#FFA000]/50 px-1.5 py-[2px] text-[9px] font-black text-[#FFA000] uppercase tracking-widest">
                          Pending
                        </span>
                      ) : (
                        <span className="rounded-sm bg-[#0d1117] border border-[#3d4f5f] px-1.5 py-[2px] text-[9px] font-black text-[#5a6a7a] uppercase tracking-widest">
                          Awaiting Price
                        </span>
                      )}
                      {/* Status */}
                    ...
                    <div className="flex items-center gap-4">
                      <div className="w-[72px] h-[72px] bg-[#0a0a15] border border-[#3d4f5f] rounded-full flex items-center justify-center shadow-[inset_0_2px_4px_rgba(0,0,0,0.8),0_0_5px_rgba(0,212,255,0.1)] p-1 flex-shrink-0">
                        {teamLogo(g.awayId) ? (
                          ...
                          <span className="text-[10px] text-[#5a6a7a] font-black">
                            {g.away?.slice(0, 3)}
                          </span>
                        )}
                      </div>
