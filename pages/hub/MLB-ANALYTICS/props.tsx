    ...
    return (
      <div
        ...
        style={{
          ...
          boxShadow: `inset 0 2px 6px rgba(0,0,0,0.8), 0 0 8px ${tierColor}33`,
        }}
      >
        <Image
          unoptimized
    ...
    return (
      <div
        ...
        style={{
          width: sz,
          height: sz,
          boxShadow: 'inset 0 2px 6px rgba(0,0,0,0.8), 0 0 8px rgba(0,212,255,0.1)',
        }}
      >
        <Image
          unoptimized
      ...
      >
        ...
        <div className="flex flex-col items-center pt-5 pb-4 px-4 border-b border-[#2a3a4a] relative overflow-hidden">
          <div
            ...
            style={{
              background: `radial-gradient(circle at 50% 0%, ${ts.bg} 0%, transparent 70%)`,
            }}
          />
        ...
        <div className="px-4 py-4 mt-auto">
          <div className="text-[12px] text-[#5a6a7a] text-center leading-relaxed font-black tracking-wide capitalize">
            ...
            <span className="text-[#8a9ba8]">
              Bet Score (0–100) ranks value (EV + confidence). Bet responsibly.
            </span>
          </div>
        </div>
      </div>
    ...
    >
      <SEOHead
        ...
        jsonLd={{
          ...
          description:
            "AI-graded MLB player prop bets with Bet Scores, over/under recommendations, Kelly Criterion sizing, and model vs. market probability comparisons for today's slate.",
      ...
      {/* ── Page Header ──────────────────────────────────────────── */}
      <div className="relative px-4 pt-5 pb-4 bg-gradient-to-b from-[#1a2332] to-[#0d1117] border-b-[3px] border-[#3d4f5f] shadow-[0_8px_30px_rgba(0,0,0,0.8)] z-10">
