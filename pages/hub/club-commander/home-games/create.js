...
export default function CreateHomeGamePage() {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      if (!token) {
        router.push('/login?redirect=/hub/club-commander/home-games/create');
        return;
      }
      ...
      const res = await fetch('/api/club-commander/home-games/groups', {
        method: 'POST',
        headers: {
      ...
      if (data.success || data.group) {
        router.push(`/hub/club-commander/home-games/${data.group.id}`);
      } else {
