/**
 * Player Club Commander Hub - Browse venues and manage waitlists
...
import VenueCard from '../../../src/components/club-commander/player/VenueCard';
import WaitlistCard from '../../../src/components/club-commander/player/WaitlistCard';

export default function ClubCommanderHub() {
  ...
  async function fetchVenues() {
    try {
      let url = '/api/club-commander/venues?captain_enabled=true&limit=20';
  ...
  async function fetchMyWaitlists() {
    try {
      const res = await fetch('/api/club-commander/waitlist/my');
      const data = await res.json();
