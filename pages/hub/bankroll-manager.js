          ...
          <main className="bankroll-main-content" style={styles.mainContent}>
            ...
            {activeSection === 'dashboard' && categoryFilter === 'all' && (
              <>
                ...
                <div className="bankroll-analytics-slider" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 12, marginBottom: 16, alignItems: 'stretch', maxHeight: 320, overflow: 'hidden' }}>
