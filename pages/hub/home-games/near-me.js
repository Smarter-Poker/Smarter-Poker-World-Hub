    ...
    <div className="min-h-screen bg-[#0A1526] text-white" style={{ fontFamily: "var(--font-inter), -apple-system, BlinkMacSystemFont, sans-serif" }}>
      ...
      <div className="sticky top-0 z-10 border-b border-[#1E293B] bg-[#0A1526]/95 backdrop-blur-sm">
        <div className="max-w-5xl mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <Link href="/hub/commander/home-games/create" className="cmd-btn cmd-btn-primary h-9 px-4 text-xs">
            Host a Game
          </Link>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-4 py-6 space-y-6">
        ...
        {status === 'ready' && groups.length === 0 && (
          <div className="cmd-panel p-8 text-center">
            ...
            <Link href="/hub/commander/home-games/create" className="cmd-btn cmd-btn-primary h-10 px-5 text-sm inline-flex items-center gap-2 mt-4">
              Host a Home Game
            </Link>
          </div>
        )}
