...
const SEEDED_HOME_GAMES = [
  { id: 'hg-001', name: "Ace's Basement Grind", host_display_name: 'BigSlickSteve', host_username: 'bigslicksteve', city: 'Chicago', state: 'IL', latitude: 41.8781, longitude: -87.6298, venue_type: 'home_game', games_offered: ['NLH 1/2', 'NLH 2/5'], trust_score: 4.5, max_players: 9, is_recurring: true, schedule: 'Every Friday 7:00 PM', description: 'Weekly deep-stack NLH in Wicker Park. BYOB. Serious players only.' },
  { id: 'hg-002', name: "Big Slick Saturdays", host_display_name: 'VegasVince', host_username: 'vegasvince', city: 'Las Vegas', state: 'NV', latitude: 36.1699, longitude: -115.1398, venue_type: 'home_game', games_offered: ['NLH 2/5', 'PLO4 2/5'], trust_score: 4.8, max_players: 8, is_recurring: true, schedule: 'Every Saturday 6:00 PM', description: 'High-action mixed game night off the Strip. Dealers provided.' },
  { id: 'hg-003', name: "River Rat's Den", host_display_name: 'RiverRatRay', host_username: 'riverratray', city: 'Austin', state: 'TX', latitude: 30.2672, longitude: -97.7431, venue_type: 'home_game', games_offered: ['NLH 1/2'], trust_score: 4.2, max_players: 10, is_recurring: true, schedule: 'Every Wednesday 8:00 PM', description: 'Casual home game in South Austin. Great food, cold beer.' },
  { id: 'hg-004', name: "The Shark Tank", host_display_name: 'SharkDaddy', host_username: 'sharkdaddy305', city: 'Miami', state: 'FL', latitude: 25.7617, longitude: -80.1918, venue_type: 'home_game', games_offered: ['NLH 2/5', 'NLH 5/10'], trust_score: 4.7, max_players: 9, is_recurring: true, schedule: 'Every Thursday 9:00 PM', description: 'Brickell penthouse game. Must be vouched in. Deep stacks.' },
