...
const DEFAULT_RANGES = {
  ...
  BTN: {
    range: '22+, A2s+, K2s+, Q5s+, J7s+, T7s+, 97s+, 87s, 76s, A5o+, K9o+, QTo+, JTo',
    pct: 40.8,
  },
  SB: { range: '22+, A2s+, K2s+, Q5s+, J7s+, T7s+, 97s+, 87s, A2o+, K7o+, Q9o+, J9o+', pct: 43.5 },
  BB: {
    range: 'Defend vs 2.5x: 22+, A2s+, K2s+, Q2s+, J5s+, T6s+, 96s+, 86s+, 75s+, 65s, 54s',
    pct: 52.0,
  },
};
...
const BOARD_TEXTURES = [
  ...
  { id: 'wet', label: 'Wet', example: 'J♥ T♠ 8♥', boards: ['Jh Ts 8h', 'Tc 9c 7d', '8s 7s 6h'] },
  {
    ...
    label: 'Paired',
    example: 'K♠ K♦ 5♣',
    boards: ['Ks Kd 5c', 'Ah Ad 7s', '9c 9h 3d'],
  },
  {
    id: 'monotone',
    label: 'Monotone',
    example: 'Q♠ 9♠ 4♠',
    boards: ['Qs 9s 4s', 'Jh 7h 3h', 'Td 6d 2d'],
  },
  {
    id: 'broadw',
    label: 'Broadway',
    example: 'A♦ K♠ Q♥',
    boards: ['Ad Ks Qh', 'Kh Qc Js', 'As Jd Tc'],
  },
];
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Analyze multiway postflop scenarios with 3 players and custom ranges"
        />
      </Head>
      ...
      >
        <div style={{ padding: '16px 20px', borderBottom: '1px solid #3a3b3c' }}>
          ...
          >
            3-Way Postflop Solver
          </h1>
          <p style={{ fontSize: 14, color: '#b0b3b8', margin: '2px 0 0' }}>
            Configure multiway postflop scenarios with custom positions and ranges
          </p>
        </div>
        ...
        <div style={{ padding: '16px 20px', maxWidth: 900, margin: '0 auto' }}>
          ...
          >
            ...
            >
              ...
              >
                Strategy — {players[selectedPlayer].pos} (
                {potType === 'srp' ? 'Single Raised Pot' : '3-Bet Pot'})
              </h3>
              <div
                style={{
                  padding: '3px 10px',
              ...
              {players.map((p, i) => (
                <div
                  ...
                  style={{
                    ...
                    borderRadius: 8,
                    background:
                      selectedPlayer === i ? 'rgba(99,102,241,0.06)' : 'rgba(255,255,255,0.02)',
                ...
                >
                  ...
                  >
                    ...
                    <span style={{ fontSize: 12, fontWeight: 700, color: '#e4e6eb' }}>
                      {(DEFAULT_RANGES[p.pos] || { pct: 0 }).pct}%
                    </span>
                  </div>
                  <div
                    style={{
