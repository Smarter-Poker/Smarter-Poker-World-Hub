        ...
        >
            ...
            >
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 8, marginBottom: 16 }}>
                    <div style={{ padding: '10px', borderRadius: 8, background: 'rgba(0,0,0,0.3)', textAlign: 'center' }}>
                        <div style={{ fontSize: 18, fontWeight: 800, color: '#ef4444' }}>
                            {cell.evLoss?.toFixed(1) || '0.0'}
                        </div>
                        <div style={{ fontSize: 9, color: '#64748b', textTransform: 'uppercase', letterSpacing: 0.5 }}>EV LOSS (BB)</div>
                    </div>
                    <div style={{ padding: '10px', borderRadius: 8, background: 'rgba(0,0,0,0.3)', textAlign: 'center' }}>
                    ...
                    <div style={{ padding: '10px', borderRadius: 8, background: 'rgba(0,0,0,0.3)', textAlign: 'center' }}>
                        ...
                        <div style={{ fontSize: 9, color: '#64748b', textTransform: 'uppercase', letterSpacing: 0.5 }}>CORRECT</div>
                    </div>
                </div>
...
export default function PerformanceHeatmapPage() {
    ...
    function processHeatmapData(sessions) {
        ...
        // Build grid cells
        const grid = {};
        let totalHands = 0, totalCorrect = 0, totalEV = 0;
        ...
        Object.keys(grid).forEach(key => {
            const cell = grid[key];
            cell.accuracy = cell.handsPlayed > 0
                ? Math.round((cell.correct / cell.handsPlayed) * 100)
                : null;
    ...
    function generateMistakePatterns(key, cell) {
        ...
        const patterns = [
            ...
            { action: 'Called', correct: 'Raised', count: Math.max(1, Math.round(cell.mistakes * 0.30)) },
            { action: 'Check', correct: 'Bet', count: Math.max(1, Math.round(cell.mistakes * 0.20)) },
        ];
                ...
                <div style={{ padding: '20px 16px', maxWidth: 600, margin: '0 auto' }}>
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <div style={{ fontSize: 9, color: '#64748b', textTransform: 'uppercase', letterSpacing: 0.5 }}>HANDS</div>
                        </div>
                        <div style={{
                            padding: '14px', borderRadius: 12,
                            background: 'rgba(0,0,0,0.2)', border: '1px solid rgba(255,255,255,0.05)',
                            ...
                            <div style={{ fontSize: 22, fontWeight: 800, color: getTextColor(totalStats.accuracy) }}>
                                {totalStats.accuracy}%
                            </div>
                            <div style={{ fontSize: 9, color: '#64748b', textTransform: 'uppercase', letterSpacing: 0.5 }}>ACCURACY</div>
                        </div>
                        <div style={{
                            padding: '14px', borderRadius: 12,
                            background: 'rgba(0,0,0,0.2)', border: '1px solid rgba(255,255,255,0.05)',
                            ...
                            <div style={{ fontSize: 22, fontWeight: 800, color: '#ef4444' }}>
                                {totalStats.evLoss.toFixed(1)}
                            </div>
                            <div style={{ fontSize: 9, color: '#64748b', textTransform: 'uppercase', letterSpacing: 0.5 }}>EV LOSS</div>
                        </div>
                    </div>
                    ...
                    {!loading && (
                        <div style={{
                            ...
                            <div style={{
                                ...
                                <div style={{ padding: '10px 6px', fontSize: 9, fontWeight: 700, color: '#475569', textAlign: 'center' }} />
                                {STREETS.map(s => (
                                    <div key={s} style={{
                            ...
                            {POSITIONS.map((pos, posIdx) => (
                                ...
                                >
                                    {/* Row header */}
                                    <div style={{
                                        padding: '14px 6px', fontSize: 11, fontWeight: 700,
                                        color: '#94a3b8', textAlign: 'center',
                        ...
                        {[
                            ...
                            <div key={l.label} style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                                <div style={{
                                    ...
                                    background: l.color, opacity: 0.7,
                                }} />
