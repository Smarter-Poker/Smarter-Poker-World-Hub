...
const ACTION_OPTIONS = ['Fold', 'Call', 'Raise 2.5x', 'Raise 3x', 'Check', 'Bet 33%', 'Bet 50%', 'Bet 75%', 'Bet 100%', 'All-In'];
    ...
    return (
        ...
        >
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 6, marginBottom: 10 }}>
                <div>
                    <div style={{ fontSize: 9, color: '#64748b', fontWeight: 700, textTransform: 'uppercase', marginBottom: 4 }}>YOUR POS</div>
                    <select
                ...
                <div>
                    <div style={{ fontSize: 9, color: '#64748b', fontWeight: 700, textTransform: 'uppercase', marginBottom: 4 }}>VILLAIN</div>
                    <select
                ...
                <div>
                    <div style={{ fontSize: 9, color: '#64748b', fontWeight: 700, textTransform: 'uppercase', marginBottom: 4 }}>STREET</div>
                    <select
            ...
            <div style={{ marginBottom: 10 }}>
                <div style={{ fontSize: 9, color: '#64748b', fontWeight: 700, textTransform: 'uppercase', marginBottom: 4 }}>SCENARIO</div>
                <textarea
            ...
            {/* Correct Action */}
            <div style={{ marginBottom: 10 }}>
                <div style={{ fontSize: 9, color: '#64748b', fontWeight: 700, textTransform: 'uppercase', marginBottom: 4 }}>CORRECT ACTION</div>
                <select
            ...
            {/* Explanation */}
            <div>
                <div style={{ fontSize: 9, color: '#64748b', fontWeight: 700, textTransform: 'uppercase', marginBottom: 4 }}>EXPLANATION (OPTIONAL)</div>
                <textarea
                            ...
                            <div style={{ display: 'flex', gap: 8, marginTop: 12 }}>
                                ...
                                <motion.button
                                    ...
                                    style={{
                                        ...
                                        fontSize: 13, fontWeight: 700, cursor: quizName.trim() ? 'pointer' : 'not-allowed',
                                    }}
                                >
                                    Save Quiz
                                </motion.button>
                        ...
                        <>
                            {savedQuizzes.length === 0 && (
                                <div style={{ textAlign: 'center', padding: '60px 20px', color: '#64748b' }}>
                                    ...
                                    <div style={{ fontSize: 14, fontWeight: 600, color: '#94a3b8' }}>No quizzes yet</div>
                                    <div style={{ fontSize: 11, marginTop: 4 }}>Switch to Build tab to create your first quiz</div>
                                </div>
                            )}
                            {savedQuizzes.map(quiz => (
                                ...
                                >
                                    <div>
                                        <div style={{ fontSize: 14, fontWeight: 700, color: '#e2e8f0' }}>{quiz.name}</div>
