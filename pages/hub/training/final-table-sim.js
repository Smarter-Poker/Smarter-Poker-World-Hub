            ...
            <div style={styles.container}>
                ...
                <div style={styles.content}>
                            ...
                            <div style={styles.playersList}>
                                {players.map(p => (
                                    <div key={p.id} style={styles.playerRow}>
                                        <div style={{ ...styles.playerName, color: p.name === 'Hero' ? '#00d4ff' : '#e2e8f0' }}>
                                            {p.name}
                                        </div>
                                        <input
                                            type="number"
                            ...
                            <div style={styles.payoutsList}>
                                {payouts.map((amount, i) => (
                                    <div key={i} style={styles.payoutRow}>
                                        <div style={styles.payoutPlace}>{i + 1}{i === 0 ? 'st' : i === 1 ? 'nd' : i === 2 ? 'rd' : 'th'} Place</div>
                    ...
                    <div style={styles.rightCol}>
                        <div style={styles.card}>
                            <h2 style={{ ...styles.cardTitle, color: '#fbbf24', fontSize: 24, margin: '0 0 24px 0' }}>ICM $Equity Results</h2>
                            ...
                            <table style={styles.resultsTable}>
                                ...
                                <tbody>
                                    {icmResults.sort((a, b) => b.stack - a.stack).map(p => (
                                        <tr key={p.id} style={{ background: p.name === 'Hero' ? 'rgba(0,212,255,0.1)' : 'transparent' }}>
                                            <td style={{ ...styles.td, color: p.name === 'Hero' ? '#00d4ff' : '#fff', fontWeight: p.name === 'Hero' ? 'bold' : 'normal' }}>
                                                {p.name}
                            ...
                            <div style={styles.dealBox}>
                                ...
                                <p style={{ color: '#94a3b8', fontSize: 13, marginBottom: 16 }}>
                                    Players often make deals using ICM numbers. If everyone agreed to chop the prize pool right now based on skill equity:
                                </p>
