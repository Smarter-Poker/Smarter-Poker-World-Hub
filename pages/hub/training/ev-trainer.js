...
function generateQuestion() {
    ...
    if (type === 'pot_odds') {
        ...
        return {
            type, title: 'Pot Odds', icon: '📐', color: '#00d4ff',
    ...
    if (type === 'mdf') {
        ...
        return {
            type, title: 'Min. Defense Frequency', icon: '🛡️', color: '#a855f7',
    ...
    if (type === 'ev_call') {
        ...
        return {
            type, title: 'EV of a Call', icon: '⚡', color: '#22c55e',
    ...
    const answer = Math.round((bet / (pot + bet)) * 100);
    return {
        type, title: 'Break-Even Equity', icon: '⚖️', color: '#f97316',
...
export default function EVTrainer() {
    ...
    const resultColors = {
        ...
        close: { bg: 'rgba(251, 191, 36, 0.15)', border: 'rgba(251, 191, 36, 0.5)', text: '#fbbf24', label: `⚡ CLOSE! (±${TOLERANCE})` },
            ...
            <div style={container}>
                ...
                <div style={{ maxWidth: 640, margin: '0 auto' }}>
                        ...
                        {question && (
                            ...
                            >
                                ...
                                <div style={{
                                    ...
                                    background: `${question.color}18`, border: `1px solid ${question.color}40`,
                                ...
                                <div style={{
                                    ...
                                    <p style={{ margin: 0, fontSize: 16, lineHeight: 1.7, color: '#e2e8f0', fontWeight: 600 }}>
                                ...
                                {!showBreakdown && (
                                    <div style={{ marginBottom: 16 }}>
                                        <label style={{
                                            ...
                                            color: '#64748b', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 8,
                                        }}>
                                        ...
                                        <div style={{ display: 'flex', gap: 10 }}>
                                            ...
                                            <button
                                                ...
                                                style={{
                                                    ...
                                                    fontSize: 14, cursor: 'pointer', fontFamily: "'Orbitron', monospace",
                                                }}
                                            >
                                                CHECK
                                            </button>
                                    ...
                                    {showBreakdown && result && (
                                        ...
                                        >
                                            ...
                                            <div style={{
                                                ...
                                                fontWeight: 800, color: resultColors[result].text,
                                                display: 'flex', flexWrap: 'wrap',
                                                alignItems: 'center', justifyContent: 'space-between', gap: 8,
                                            }}>
                                                <span>{resultColors[result].label}</span>
                                                <span style={{ fontFamily: "'Orbitron', monospace", fontSize: 13 }}>
                                                    Your: {userAnswer}{question.unit} · Correct: {question.answer}{question.unit}
                                                </span>
                                            </div>
                                                    ...
                                                    <div key={i} style={{
                                                        ...
                                                        <span>
                                                            {line.split('**').map((p, j) =>
                                                                j % 2 === 0
                                                                    ? <span key={j}>{p}</span>
                                                                    : <strong key={j} style={{ color: question.color }}>{p}</strong>
                                                            )}
                                                        </span>
                                                    </div>
                                                ))}
                    ...
                    <div style={{
                        ...
                        <strong style={{ color: '#64748b' }}>Tolerance Rule:</strong> Answers within ±{TOLERANCE} (for %, or ±{TOLERANCE} chips for EV) count as close ✅.
                        Exact answers build maximum streaks. Press <kbd style={{ background: '#1e2d3d', padding: '1px 5px', borderRadius: 4, fontSize: 10 }}>Enter</kbd> to submit.
                    </div>
                </div>
            </div>
        </>
