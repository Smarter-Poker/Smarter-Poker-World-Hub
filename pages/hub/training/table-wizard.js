...
export default function TableWizardPage() {
  ...
  const filtered = useMemo(() => {
    ...
    switch (sortBy) {
      case 'quality':
        ...
        break;
      case 'vpip':
        result.sort((a, b) => b.avgVPIP - a.avgVPIP);
        break;
      case 'waitlist':
  ...
  const handleJoinTable = useCallback((tableId) => {
    ...
    try {
      ...
      console.warn('[TableWizard] EventBus error:', e);
    }
  }, []);
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div>
              ...
              <p style={{ fontSize: 14, color: '#b0b3b8', margin: '2px 0 0' }}>
                Find the most profitable tables and seats
              </p>
            </div>
            <button
            ...
            {filtered.map((table) => (
              <motion.div
                ...
                style={{
                  ...
                  overflow: 'hidden',
                  background:
                    joinedTable === table.id ? 'rgba(34,197,94,0.06)' : 'rgba(255,255,255,0.03)',
                ...
                >
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                      <div
                        style={{
                          ...
                          fontSize: 10,
                          fontWeight: 700,
                          background: `${table.qualityColor}12`,
                          color: table.qualityColor,
                          letterSpacing: '0.06em',
                        }}
                      >
                        {table.qualityLabel}
                      </div>
                      <span style={{ fontSize: 14, fontWeight: 600, color: '#e4e6eb' }}>
                        {table.name}
                      </span>
                    </div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                      <span style={{ fontSize: 12, fontWeight: 600, color: '#b0b3b8' }}>
                        {table.stakes}
                      </span>
                      <div
                        style={{
                          ...
                          background: `${table.qualityColor}12`,
                          border: `1px solid ${table.qualityColor}40`,
                          fontSize: 11,
                          fontWeight: 700,
                          color: table.qualityColor,
                        }}
                  ...
                  >
                    <div style={{ display: 'flex', gap: 14 }}>
                      ...
                      <span style={{ fontSize: 11, color: '#b0b3b8' }}>
                        PFR:{' '}
                        <span style={{ color: '#e4e6eb', fontWeight: 600 }}>{table.avgPFR}%</span>
                      </span>
                      <span style={{ fontSize: 11, color: '#b0b3b8' }}>
                        Avg Pot:{' '}
                        <span style={{ color: '#e4e6eb', fontWeight: 600 }}>{table.avgPot}</span>
                      </span>
                    </div>
                      ...
                      <div style={{ padding: '0 16px 14px' }}>
                        ...
                        >
                          {[
                            ...
                            {
                              label: 'Waitlist',
                              value: table.waitlist > 0 ? `${table.waitlist} waiting` : 'Open',
                            },
                            ...
                            >
                              ...
                              <div style={{ fontSize: 12, fontWeight: 700, color: '#e4e6eb' }}>
                                {s.value}
                              </div>
                            </div>
                          ))}
                        ...
                        <div
                          style={{
                            ...
                            borderRadius: 6,
                            borderLeft: `3px solid ${table.qualityColor}`,
                            marginBottom: 10,
                          }}
                        >
                        ...
                        >
                          {joinedTable === table.id
                            ? 'JOINED'
                            : table.waitlist > 0
                              ? `JOIN WAITLIST (${table.waitlist} ahead)`
                              : 'JOIN TABLE'}
                        </button>
                      </div>
                    </motion.div>
