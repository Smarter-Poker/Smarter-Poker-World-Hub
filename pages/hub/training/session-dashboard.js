  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Review your GTO training sessions, track accuracy trends, and identify weak spots in your game."
        />
        <link
        ...
        <div style={{ padding: '16px 24px', maxWidth: 700, margin: '0 auto' }}>
              ...
              >
                {[
                  ...
                  { label: 'Mastered', value: stats?.totalGamesMastered || 0, color: '#22c55e' },
                  {
                    ...
                    color: stats?.overallAccuracy >= 70 ? '#22c55e' : '#f97316',
                  },
                  { label: 'Best Streak', value: stats?.bestStreak || 0, color: '#a855f7' },
                  {
                    label: 'Questions',
                    value: (stats?.totalQuestionsAnswered || 0).toLocaleString(),
                    color: '#3b82f6',
                  },
                  {
                    label: 'Correct',
                        ...
                        <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
                          ...
                          {s.hand_history && s.hand_history.length > 0 && (
                            <button
                              onClick={() =>
                                setActiveReplay({
                                  sessionName: s.game_id || 'Session',
                                  handHistory: s.hand_history,
                                })
                              }
                              style={{
              ...
              {weakSpots.length === 0 ? (
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                  {weakSpots.map((spot, i) => {
                    const acc =
                      spot.total_questions_answered > 0
                        ? Math.round((spot.total_correct / spot.total_questions_answered) * 100)
                        : 0;
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          {spot.total_correct}/{spot.total_questions_answered} correct · Mastery:{' '}
                          {spot.mastery_percentage || 0}%
                        </div>
                      </div>
                    );
                  })}
                  ...
                  >
                    These are your lowest-accuracy areas. Focus your training sessions here to
                    improve your overall GTO accuracy.
                  </div>
                </div>
              )}
            </motion.div>
          ...
          >
            ...
            <p style={{ fontSize: 12, color: '#94a3b8', lineHeight: 1.6, margin: 0 }}>
              Track your GTO training progress over time. The Overview tab shows overall stats and
              accuracy trends. Sessions shows your complete training history. Weak Spots highlights
              areas where your accuracy is lowest so you can focus your practice.
            </p>
          </div>
        </div>
      </div>
