...
export default function PokerNearMePage() {
    ...
    const [sidebarFilters, setSidebarFilters] = useState({
        gameType: 'all', // 'all', 'cash', 'mtt', 'mixed'
        stakes: 'all', // 'all', '$1/25', '$2/5', '$5/10+'
        minBuyin: '',
        maxBuyin: '',
        hasFood: false,
        hasHotel: false,
    ...
    const renderMap = () => {
        // Filter venues based on map filters and sidebar filters
                ...
                <div className="map-main-section">
                    ...
                    <div className="map-header">
                        ...
                        <div className="map-header-right">
                            ...
                            <button className="map-view-toggle" onClick={() => setActiveTab('venues')}>
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                        ...
                        <div className="sidebar-filter-group">
                            ...
                            <div className="sidebar-checkboxes">
                                <label className="sidebar-checkbox">
                                    <input type="checkbox" checked={sidebarFilters.hasFood} onChange={() => setSidebarFilters(prev => ({ ...prev, hasFood: !prev.hasFood }))} />
                                    <span>Food</span>
                                </label>
                                <label className="sidebar-checkbox">
                                    <input type="checkbox" checked={sidebarFilters.hasHotel} onChange={() => setSidebarFilters(prev => ({ ...prev, hasHotel: !prev.hasHotel }))} />
                                    <span>Hotel</span>
                                </label>
                                <label className="sidebar-checkbox">
                                    <input type="checkbox" checked={sidebarFilters.hasParking} onChange={() => setSidebarFilters(prev => ({ ...prev, hasParking: !prev.hasParking }))} />
                                    <span>Parking</span>
                                </label>
                                <label className="sidebar-checkbox">
                                    <input type="checkbox" checked={sidebarFilters.is24Hours} onChange={() => setSidebarFilters(prev => ({ ...prev, is24Hours: !prev.is24Hours }))} />
                                    <span>24/7</span>
                                </label>
                            </div>
                        </div>
                    ...
                    {selectedRoom && (
                        <div className="room-detail-panel">
                            <div className="room-detail-header">
                                <div className="room-detail-image" style={{ backgroundImage: selectedRoom.image_url ? `url(${selectedRoom.image_url})` : 'linear-gradient(135deg, #1e3a5f, #0f172a)' }}></div>
                                <div className="room-detail-rating">
                                    <span className="rating-score">{(selectedRoom.trust_score || 4.0).toFixed(1)}</span>
                                    <svg width="14" height="14" viewBox="0 0 24 24" fill="#f59e0b" stroke="#f59e0b" strokeWidth="2">
                                        <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />
                                    </svg>
                                </div>
                            ...
                            <div className="room-detail-section">
                                ...
                                <div className="room-detail-games">
                                    {(selectedRoom.stakes_cash || ['$1/2 NLH', '$2/5 NLH']).slice(0, 3).map((stake, i) => (
                                        <div key={i} className="room-game-row">
                                            <span className="room-game-stake">{stake}</span>
                                            <span className="room-game-info">{Math.floor(Math.random() * 5) + 1} tables</span>
                                        </div>
                                    ))}
                                </div>
                            </div>
                            ...
                            <div className="room-detail-section">
                                ...
                                <div className="room-detail-tournaments">
                                    <div className="room-tournament-row">
                                        <span className="tournament-buyin">$125 NLH</span>
                                        <span className="tournament-time">7:00 PM</span>
                                        <span className="tournament-gtd">$5,000 GTD</span>
                                    </div>
                                    <div className="room-tournament-row">
                                        <span className="tournament-buyin">$400 NLH</span>
                                        <span className="tournament-time">Sat, 5PM</span>
                                        <span className="tournament-gtd">$30,000 GTD</span>
                                    </div>
                                </div>
                            </div>
        ...
        <>
            ...
            <div className="pnm-page">
                ...
                <style jsx>{`
                    ...
                    /* Map-First UI Styles - Enhanced Desktop Layout */
                    .map-desktop-layout {
                        display: grid;
                    ...
                    @media (max-width: 900px) {
                        ...
                        .sidebar-filters, .room-detail-panel {
                            flex: 1;
                            min-width: 280px;
                        }
                    }
