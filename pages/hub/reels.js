...
import { YouTubeErrorOverlay, reportFailureToServer, reportToSentry } from '../../src/hooks/useYouTubeErrorManager';
            ...
            try {
                ...
                if (data?.event === 'onError' && data?.info) {
                    ...
                    try {
                        ...
                        if (vid) { reportFailureToServer(vid, errorCode, 'HubReels'); reportToSentry(vid, errorCode, 'HubReels'); }
                    } catch { /* best-effort */ }
                }
