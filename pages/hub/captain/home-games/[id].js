...
function EventCard({ event, onRsvp, userRsvp }) {
  ...
  return (
    <div className={`cap-panel p-4 ${isPast ? 'opacity-60' : ''}`}>
          ...
          {userRsvp === 'yes' ? (
            <>
              <button
                ...
                className="cap-btn cap-btn-secondary flex-1 h-10"
              >
                Cancel
              </button>
            ...
            <>
              <button
                ...
                className="cap-btn cap-btn-primary flex-1 h-10"
              >
                Confirm
              </button>
              <button
            ...
            <>
              <button
                onClick={() => onRsvp?.(event, 'yes')}
                disabled={isFull}
                className="cap-btn cap-btn-primary flex-1 h-10 disabled:opacity-50"
              >
                {isFull ? 'Full' : "I'm In"}
              </button>
              <button
