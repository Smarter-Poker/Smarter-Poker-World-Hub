      ...
      <div className="cap-page">
        ...
        {isJoined && myRank > 0 && (
          <div className="max-w-lg mx-auto px-4 -mt-4">
            <div className="cap-panel p-4 shadow-sm">
        ...
        <main className="max-w-lg mx-auto px-4 py-6 space-y-6">
          ...
          {!isJoined && (
            <button
              ...
              disabled={joining}
              className="cap-btn cap-btn-primary w-full h-14 text-lg font-semibold disabled:opacity-50 flex items-center justify-center gap-2"
            >
          ...
          {activeTab === 'events' && (
            <section className="space-y-3">
              {events.length > 0 ? (
                ...
                <div className="cap-panel p-6 text-center text-[#64748B]">
                  No events scheduled
                </div>
              )}
            </section>
