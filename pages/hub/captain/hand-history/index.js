...
function HandCard({ hand, onClick }) {
  ...
  return (
    <button
      ...
      className="w-full cap-panel p-4 text-left hover:shadow-[0_0_15px_rgba(34,211,238,0.15)] hover:border-[#22D3EE]/50 transition-all"
    >
...
function SessionCard({ session, onSelect }) {
  return (
    <button
      ...
      className="w-full cap-panel p-4 text-left hover:shadow-[0_0_15px_rgba(34,211,238,0.15)] hover:border-[#22D3EE]/50 transition-all relative"
    >
