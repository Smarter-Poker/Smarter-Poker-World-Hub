...
export default function CommanderLogin() {
  ...
  // Fetch commander-enabled venues
  useEffect(() => {
    fetchVenues();
  }, []);
            ...
            <div className="cmd-panel overflow-hidden">
              {loading ? (
                ...
                <div className="p-8 text-center">
                  ...
                  <p className="text-sm text-[#4A5E78] mt-1">Contact admin to enable Commander</p>
                </div>
              ) : (
    ...
    <>
      ...
      <div className="min-h-screen bg-[#0B1426] flex flex-col items-center justify-center p-4">
        <div className="w-full max-w-sm">
          ...
          {/* PIN Display */}
          <div className="cmd-panel p-6 mb-4">
            ...
            <button
              ...
              className="w-full mt-4 h-14 rounded-xl text-lg font-semibold cmd-btn cmd-btn-primary disabled:opacity-50 disabled:cursor-not-allowed"
            >
