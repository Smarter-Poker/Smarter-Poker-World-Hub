...
export default function TDTablesMap() {
  ...
  // ── Seat Change Card printer (auto-break eliminations) ──
...
.card { width: 72mm; margin: 0 auto; padding: 5mm 4mm; border-bottom: 2px dashed #000; page-break-after: always; }
...
.new-seat-box { border: 2px solid #000; border-radius: 3mm; padding: 3mm; text-align: center; margin: 2mm 0; background: #f9f9f9; }
