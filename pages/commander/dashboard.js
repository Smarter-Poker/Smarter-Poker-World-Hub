...
const CARDS = [
  ...
  },
  {
    ...
    features: [
      ...
      { label: 'Dealer Rotation', href: '/commander/dealer-rotation', icon: '/images/commander/icons/mg-employee.png' },
  ...
  },
  {
    ...
    features: [
      ...
      { label: 'Player Reports', href: '/commander/reports/player-activity', icon: '/images/commander/icons/rp-players.png' },
      { label: 'System Info', href: '/commander/system-info', icon: '/images/commander/icons/rp-system.png' },
      { label: 'Responsible Gaming', href: '/commander/responsible-gaming', icon: '/images/commander/icons/wl-player-view.png' },
      { label: 'Marketplace', href: '/commander/marketplace', icon: '/images/commander/icons/rp-tournaments.png' },
      { label: 'Exports', href: '/commander/exports', icon: '/images/commander/icons/rp-config.png' },
      { label: 'Downloads', href: '/commander/downloads', icon: '/images/commander/icons/rp-configuration.png' },
    ],
  },
];
