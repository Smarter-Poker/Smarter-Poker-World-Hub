...
const CARDS = [
  ...
  },
  {
    ...
    features: [
      ...
      { label: 'Clock Set Up', href: '/commander/tournaments/clock-setup', icon: '/images/commander/icons/tn-clock-setup.png' },
  ...
  },
  {
    ...
    features: [
      ...
      { label: 'Membership Plans', href: '/commander/membership-plans', icon: '/images/commander/icons/wl-player-maintenance.png' },
    ],
  },
  {
    id: 'reports',
    ...
    features: [
      ...
      { label: 'Revenue Report', href: '/commander/reports/revenue', icon: '/images/commander/icons/rp-custom.png' },
