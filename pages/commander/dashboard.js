...
const CARDS = [
  ...
  },
  {
    ...
    features: [
      ...
      { label: 'Tournament Results', href: '/commander/reports/tournament-results', icon: '/images/commander/icons/rp-tournaments.png' },
  ...
  },
  {
    ...
    features: [
      ...
      { label: 'Cashier', href: '/commander/cashier', icon: '/images/commander/icons/rp-configuration.png' },
  ...
  },
  {
    ...
    features: [
      ...
      { label: 'Player Activity', href: '/commander/reports/player-activity', icon: '/images/commander/icons/rp-players.png' },
      ...
      { label: 'Tax / W-2G', href: '/commander/reports/tax-compliance', icon: '/images/commander/icons/rp-tournaments.png' },
      ...
      { label: 'Close Day', href: '/commander/close-day', icon: '/images/commander/icons/rp-configuration.png' },
