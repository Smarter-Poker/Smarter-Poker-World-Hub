...
export default function StaffActivity() {
  ...
  return (
    <CommanderLayout title="Staff Activity" backHref="/commander/reports"><div className="min-h-screen bg-[#18191A] text-[#E4E6EB] font-['Inter']">
              ...
              {activities.map(a => (
                <div key={a.id} className="bg-[#242526] rounded-xl border border-[#3A3B3C] p-4 flex items-start gap-3">
                  ...
                  <span className={`text-xs px-2 py-0.5 rounded-full ${
                    a.status === 'open' ? 'bg-[#F59E0B]/20 text-[#F59E0B]' :
