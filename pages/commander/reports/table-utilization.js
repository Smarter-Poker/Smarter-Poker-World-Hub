...
import { ArrowLeft, LayoutGrid, Loader2, RefreshCw, Clock, Users, TrendingUp, Zap } from 'lucide-react';
    ...
    <>
      ...
      <div className="min-h-screen bg-[#18191A] text-[#E4E6EB] font-['Inter']">
        <div className="bg-[#242526] border-b border-[#3A3B3C] px-4 py-3 flex items-center gap-3">
          <button onClick={() => router.push('/commander/reports')} className="p-2 rounded-lg active:bg-[#3A3B3C]"><img src="/images/btn-back.png" alt="Back" style={{ height: 44, objectFit: 'contain' }} /></button>
