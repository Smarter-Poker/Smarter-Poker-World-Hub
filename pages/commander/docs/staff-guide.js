                  ...
                  <div className="space-y-8">
                    {currentSection.content.map((item, idx) => (
                      <div key={idx} className="border-b border-[#374151] pb-6 last:border-0">
                        ...
                        {item.note && (
                          <div className="flex items-start gap-2 p-3 bg-[#22D3EE]/5 border border-[#22D3EE]/20 rounded-lg">
                        ...
                        {item.tip && (
                          <div className="flex items-start gap-2 p-3 bg-[#10B981]/5 border border-[#10B981]/20 rounded-lg">
                            <CheckCircle className="w-5 h-5 text-[#10B981] flex-shrink-0 mt-0.5" />
                            <p className="text-sm text--[#10B981]">{item.tip}</p>
                          </div>
                        )}
                      </div>
                    ))}
