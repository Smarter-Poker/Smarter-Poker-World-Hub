...
import {
  ArrowLeft, Save, Plus, Trash2, GripVertical, Clock, DollarSign,
...
const STRUCTURE_TEMPLATES = {
  ...
  standard: {
    ...
    levels: [
      ...
      { small_blind: 4000, big_blind: 8000, ante: 1000, duration: 15 }
    ]
  },
  deep_stack: {
    name: 'Deep Stack',
    ...
    levels: [
      ...
      { small_blind: 1000, big_blind: 2000, ante: 300, duration: 25 },
      { small_blind: 1200, big_blind: 2400, ante: 400, duration: 20 },
      { is_break: true, duration: 15 },
      ...
      { small_blind: 5000, big_blind: 10000, ante: 1000, duration: 20 }
    ]
  }
};
