...
const STRUCTURE_TEMPLATES = {
  turbo: {
    name: 'Turbo',
    description: '10-min Levels, BB Ante, Fast Action',
  ...
  standard: {
    name: 'Standard',
    description: '20-min Levels, BB Ante, Balanced Pace',
  ...
  deep_stack: {
    name: 'Deep Stack',
    description: '30-min Levels, BB Ante, Lots of Play',
    ...
    levels: [
      ...
      { is_break: true, duration: 10 },
      { small_blind: 1500, big_blind: 3000, ante: 3000, duration: 25 },
      { small_blind: 2000, big_blind: 4000, ante: 4000, duration: 25 },
      { small_blind: 3000, big_blind: 6000, ante: 6000, duration: 25 },
      { small_blind: 4000, big_blind: 8000, ante: 8000, duration: 25 },
      { small_blind: 5000, big_blind: 10000, ante: 10000, duration: 25 }
    ]
  }
};
