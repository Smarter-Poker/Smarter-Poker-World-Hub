-- ═══════════════════════════════════════════════════════════════════════
-- 20260513_fix_remaining_lint_errors_part3.sql
-- ═══════════════════════════════════════════════════════════════════════
-- TIER:        3
-- AUTHOR:      antigravity
-- AFFECTS:     functions
...
--
-- WHY:
--   - fn_check_anti_farming_gift_cap queried 'sender_id' which does not exist
--     on diamond_transactions. Changed to `user_id` and types `*_gift_sent`.
-- ═══════════════════════════════════════════════════════════════════════
