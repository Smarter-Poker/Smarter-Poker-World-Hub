-- migration 20260618000005_mlb_backtest_accuracy_rpc.sql
-- This migration updates the get_mlb_backtest_stats RPC to include the dailyTrend data
-- inside the same payload, saving a database round trip.
...
BEGIN
  ...
  SELECT
    ...
    AVG(clv_pts) FILTER (WHERE rec LIKE '%BET%' AND rec NOT LIKE '%NO BET%')
  INTO
    v_total_predictions,
    v_won_bets,
    v_lost_bets,
