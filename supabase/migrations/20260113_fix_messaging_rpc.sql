-- ═══════════════════════════════════════════════════════════════════════════
-- FIX MESSAGING RPC FUNCTIONS - Add SECURITY DEFINER
-- This allows the functions to bypass RLS when called by authenticated users
-- ═══════════════════════════════════════════════════════════════════════════

-- 1. Fix fn_send_message - Add SECURITY DEFINER
...
-- 2. Fix fn_get_or_create_conversation - Add SECURITY DEFINER
...
-- 3. Fix fn_mark_messages_read - Add SECURITY DEFINER
