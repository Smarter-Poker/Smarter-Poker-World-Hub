-- =====================================================================
-- Migration: Fix fn_get_or_create_conversation schema column typo
-- Purpose: The previous migration incorrectly referenced 'conversation_type'
--          instead of the actual 'type' column on 'messenger_conversations'.
-- =====================================================================
